...
| 8.2. Interface |
| [Prev](SMPPLogPermfailHook.php)  | Chapter 8. SMPP Log Permfail Hook |  [Next](SMPPLogPermfailHook.examples.php) |

## 8.2. Interface

### 8.2.1. Function Interface for Lua

`function mod:smpp_log_permfail(conn, msg, error)`
### 8.2.2. Function Interface for C
...
| [Prev](SMPPLogPermfailHook.php)  | [Up](SMPPLogPermfailHook.php) |  [Next](SMPPLogPermfailHook.examples.php) |
| Chapter 8. SMPP Log Permfail Hook  | [Table of Contents](index.php) |  8.3. Examples |
