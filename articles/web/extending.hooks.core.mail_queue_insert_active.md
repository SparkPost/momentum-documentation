...
| [Prev](extending.hooks.core.mail_queue_get_next_active.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.mail_queue_maintain_domain.php) |

<a name="extending.hooks.core.mail_queue_insert_active"></a>
## Name
...
`mail_queue * <var class="pdparam">mq</var>`;
`abstract_message * <var class="pdparam">message</var>`;<a name="idp21950112"></a>
## Description
...
| [Prev](extending.hooks.core.mail_queue_get_next_active.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.mail_queue_maintain_domain.php) |
