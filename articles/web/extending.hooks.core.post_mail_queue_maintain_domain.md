...
| [Prev](extending.hooks.core.post_initiate_connection_smtp.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.post_read_smtp.php) |

<a name="extending.hooks.core.post_mail_queue_maintain_domain"></a>
## Name
...
`domain_record * <var class="pdparam">dr</var>`;
`struct timeval * <var class="pdparam">now</var>`;
`int * <var class="pdparam">rv</var>`;<a name="idp22391072"></a>
## Description
...
| [Prev](extending.hooks.core.post_initiate_connection_smtp.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.post_read_smtp.php) |
| post_initiate_connection_smtp  | [Table of Contents](index.php) |  post_read_smtp |
