...
| [Prev](extending.hooks.core.inc_outbound_conn_throttle.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.inc_outbound_mess_throttle.php) |

<a name="extending.hooks.core.inc_outbound_connections"></a>
## Name
...
`connection_handle * <var class="pdparam">connh</var>`;<a name="idp21531312"></a>
## Description
...
| [Prev](extending.hooks.core.inc_outbound_conn_throttle.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.inc_outbound_mess_throttle.php) |
| inc_outbound_conn_throttle  | [Table of Contents](index.php) |  inc_outbound_mess_throttle |
