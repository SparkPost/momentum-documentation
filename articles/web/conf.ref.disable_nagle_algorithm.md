...
| [Prev](conf.ref.delivery_method.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.disk_queue_drain_rate.php) |
...
| [Prev](conf.ref.delivery_method.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.disk_queue_drain_rate.php) |
| delivery_method  | [Table of Contents](index.php) |  disk_queue_drain_rate |
