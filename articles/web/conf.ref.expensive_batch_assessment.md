...
| [Prev](conf.ref.exclude_vctx.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.force_fsync.php) |
...
| [Prev](conf.ref.exclude_vctx.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.force_fsync.php) |
| exclude_vctx  | [Table of Contents](index.php) |  force_fsync |
