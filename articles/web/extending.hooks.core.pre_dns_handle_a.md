...
| pre_dns_handle_a |
| [Prev](extending.hooks.core.pre_console_release.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.pre_dns_handle_mx.php) |

<a name="extending.hooks.core.pre_dns_handle_a"></a>
## Name
...
`unsigned char * <var class="pdparam">abuf</var>`;
`int <var class="pdparam">alen</var>`;
`const char * <var class="pdparam">qdomain</var>`;<a name="idp22581888"></a>
## Description
...
| [Prev](extending.hooks.core.pre_console_release.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.pre_dns_handle_mx.php) |
