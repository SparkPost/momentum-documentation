...
| ec_ip_receptions_cluster |
| [Prev](sieve.ref.ec_ip_receptions.php)  | Chapter 15. Sieve++ Function Reference |  [Next](sieve.ref.ec_ip_rejections.php) |
...
This feature also requires the inbound_audit module. See [Section 14.33, “inbound_audit – Inbound traffic analytics”](modules.inbound_audit.php "14.33. inbound_audit – Inbound traffic analytics") for more information.

<a name="example.ec_ip_receptions_cluster"></a>

**Example 15.69. ec_ip_receptions_cluster example (first form)**
...
**Example 15.70. ec_ip_receptions_cluster example (second form)**
...
| [Prev](sieve.ref.ec_ip_receptions.php)  | [Up](sieve.ref.php) |  [Next](sieve.ref.ec_ip_rejections.php) |
| ec_ip_receptions  | [Table of Contents](index.php) |  ec_ip_rejections |
