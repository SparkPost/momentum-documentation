...
### 14.17.1. Early Sender Detection
...
<a name="example.conntrol"></a>

**Example 14.22. conntrol module**

```
Validate validate/conntrol conntrol {
...
### 14.17.2. Conntrol Runtime Usage
...
| 14.16. compress_spool – Dynamic Spool Compression  | [Table of Contents](index.php) |  14.18. csapi – The Content Scanning API Module |
