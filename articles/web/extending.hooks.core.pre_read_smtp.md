...
| pre_read_smtp |
| [Prev](extending.hooks.core.pre_mailq_message_requeue.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.pre_swap_out_meta.php) |

<a name="extending.hooks.core.pre_read_smtp"></a>
## Name
...
`int <var class="pdparam">newstate</var>`;
`struct timeval * <var class="pdparam">now</var>`;
`int * <var class="pdparam">mask</var>`;<a name="idp22744416"></a>
## Description
...
| [Prev](extending.hooks.core.pre_mailq_message_requeue.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.pre_swap_out_meta.php) |
