...
| [Prev](sieve.ref.ec_ip_rejections.php)  | Chapter 15. Sieve++ Function Reference |  [Next](sieve.ref.ec_log.php) |
...
**Example 15.73. ec_ip_rejections_cluster example (first form)**
...
**Example 15.74. ec_ip_rejections_cluster example (second form)**
...
| [Prev](sieve.ref.ec_ip_rejections.php)  | [Up](sieve.ref.php) |  [Next](sieve.ref.ec_log.php) |
| ec_ip_rejections  | [Table of Contents](index.php) |  ec_log |
