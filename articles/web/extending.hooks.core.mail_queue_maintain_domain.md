...
| [Prev](extending.hooks.core.mail_queue_insert_active.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.mailq_get_next_active.php) |

<a name="extending.hooks.core.mail_queue_maintain_domain"></a>
## Name
...
`domain_record * <var class="pdparam">dr</var>`;
`struct timeval * <var class="pdparam">now</var>`;
`int * <var class="pdparam">rv</var>`;<a name="idp21971328"></a>
## Description

By registering a function for this hook, Ecelerity's internal *`mail_queue_maintain_domain`* function is disabled and replaced by calls to the functions registered.
...
| [Prev](extending.hooks.core.mail_queue_insert_active.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.mailq_get_next_active.php) |
