...
| ec_forward |
| [Prev](sieve.ref.ec_floor.php)  | Chapter 15. Sieve++ Function Reference |  [Next](sieve.ref.ec_gauge_cache.php) |
...
**Example 15.41. ec_forward example with single recipient address**
...
**Example 15.42. ec_forward example with multiple recipient addresses**
...
**Example 15.43. another ec_forward example with multiple recipient addresses**

`ec_forward "sender@mailfrom.com" ["rcpt1@rcptto.com", "rcpt2@rcptto.com"] "forwarded via sieve";`

| [Prev](sieve.ref.ec_floor.php)  | [Up](sieve.ref.php) |  [Next](sieve.ref.ec_gauge_cache.php) |
