...
| [Prev](extending.hooks.core.server_esmtp_session_abort.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.smtp_client_rcptto_args.php) |

<a name="extending.hooks.core.smtp_client_mailfrom_args"></a>
## Name
...
`delivery_construct * <var class="pdparam">dc</var>`;
`smtp_client_args * <var class="pdparam">args</var>`;<a name="idp22855328"></a>
## Description
...
| [Prev](extending.hooks.core.server_esmtp_session_abort.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.smtp_client_rcptto_args.php) |
| server_esmtp_session_abort  | [Table of Contents](index.php) |  smtp_client_rcptto_args |
