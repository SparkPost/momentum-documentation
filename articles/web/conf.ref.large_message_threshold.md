...
| [Prev](conf.ref.keep_message_dicts_in_memory.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.legacy_message_threshold.php) |
...
| [Prev](conf.ref.keep_message_dicts_in_memory.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.legacy_message_threshold.php) |
