...
| [Prev](extending.hooks.core.inc_inbound_connections.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.inc_outbound_connections.php) |

<a name="extending.hooks.core.inc_outbound_conn_throttle"></a>
## Name
...
`int <var class="pdparam">binding_id</var>`;
`domain_record * <var class="pdparam">dr</var>`;<a name="idp21514048"></a>
## Description

When a connection is initiated, this hook point is called.

| [Prev](extending.hooks.core.inc_inbound_connections.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.inc_outbound_connections.php) |
