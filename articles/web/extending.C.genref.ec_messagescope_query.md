...
| [Prev](extending.C.genref.ec_message_unlink_on_free.php)  | Chapter 17. C API Reference |  [Next](extending.C.genref.ec_ssl_set_ctx_param.php) |

<a name="extending.C.genref.ec_messagescope_query"></a>
## Name
...
`char ** <var class="pdparam">parameter</var>`;<a name="idp19929776"></a>
## Description
...
| [Prev](extending.C.genref.ec_message_unlink_on_free.php)  | [Up](extending.C.ref.php) |  [Next](extending.C.genref.ec_ssl_set_ctx_param.php) |
| ec_message_unlink_on_free  | [Table of Contents](index.php) |  ec_ssl_set_ctx_param |
