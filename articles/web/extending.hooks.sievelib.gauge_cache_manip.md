...
| gauge_cache_manip |
| [Prev](extending.hooks.sievelib.php)  | Chapter 26. Hooks in the sievelib scope |  [Next](p.appendices.php) |

<a name="extending.hooks.sievelib.gauge_cache_manip"></a>
## Name
...
`#include "hooks/sievelib/gauge_cache.h"`
...
| `int **has_sievelib_gauge_cache_manip_hook**(` | `)`; |   |

| `void **register_sievelib_gauge_cache_manip_hook_first**(` | <var class="pdparam">hook</var>, |   |
|   | <var class="pdparam">closure</var>`)`; |   |

`ec_hook_sievelib_gauge_cache_manip_func_t <var class="pdparam">hook</var>`;
`void *<var class="pdparam">closure</var>`;

| `void **register_sievelib_gauge_cache_manip_hook_last**(` | <var class="pdparam">hook</var>, |   |
|   | <var class="pdparam">closure</var>`)`; |   |

`ec_hook_sievelib_gauge_cache_manip_func_t <var class="pdparam">hook</var>`;
`void *<var class="pdparam">closure</var>`;

| `void **call_sievelib_gauge_cache_manip_hook**(` | <var class="pdparam">cache</var>, |   |
|   | <var class="pdparam">key</var>, |   |
|   | <var class="pdparam">keylen</var>, |   |
|   | <var class="pdparam">addend</var>, |   |
|   | <var class="pdparam">expiry_time</var>, |   |
...
`uint64_t <var class="pdparam">expiry_time</var>`;
`int <var class="pdparam">maxitems</var>`;
`int <var class="pdparam">replicated</var>`;<a name="idp23874208"></a>
## Description
...
| [Prev](extending.hooks.sievelib.php)  | [Up](extending.hooks.sievelib.php) |  [Next](p.appendices.php) |
| Chapter 26. Hooks in the sievelib scope  | [Table of Contents](index.php) |  Part IV. Appendices |
