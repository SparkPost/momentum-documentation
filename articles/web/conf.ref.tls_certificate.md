...
| tls_certificate |
| [Prev](conf.ref.tls_ca.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.tls_ciphers.php) |
...
tls_certificate is valid in the binding, binding_group, domain and global scopes.

| [Prev](conf.ref.tls_ca.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.tls_ciphers.php) |
