...
| [Prev](conf.ref.resolv_conf.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.response_transcode_replace.php) |
...
This feature requires the response_transcode module. See [Section 14.47, “response_transcode – Module”](modules.response_transcode.php "14.47. response_transcode – Module") for more information.
...
[response_transcode_replace](conf.ref.response_transcode_replace.php "response_transcode_replace")

| [Prev](conf.ref.resolv_conf.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.response_transcode_replace.php) |
