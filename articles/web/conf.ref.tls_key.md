...
| tls_key |
| [Prev](conf.ref.tls_ciphers.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.tls_verify.php) |
...
tls_key is valid in the binding, binding_group, domain and global scopes.

| [Prev](conf.ref.tls_ciphers.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.tls_verify.php) |
| tls_ciphers  | [Table of Contents](index.php) |  tls_verify |
