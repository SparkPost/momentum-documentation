...
| [Prev](conf.ref.mailfrom_timeout.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.masterdb_file.php) |
...
This option has no effect on Linux and Windows systems running Momentum 2.1, which use an alternative memory allocator that always uses `mmap` (or it's equivalent on Windows).
...
| [Prev](conf.ref.mailfrom_timeout.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.masterdb_file.php) |
| mailfrom_timeout  | [Table of Contents](index.php) |  masterdb_file |
