...
| [Prev](extending.C.genref.ec_message_cowref.php)  | Chapter 17. C API Reference |  [Next](extending.C.genref.ec_message_get_body_fd_for_mmap.php) |

<a name="extending.C.genref.ec_message_extract_part_to_string"></a>
## Name
...
`const char * <var class="pdparam">desired_charset</var>`;<a name="idp19144704"></a>
## Description
...
| [Prev](extending.C.genref.ec_message_cowref.php)  | [Up](extending.C.ref.php) |  [Next](extending.C.genref.ec_message_get_body_fd_for_mmap.php) |
| ec_message_cowref  | [Table of Contents](index.php) |  ec_message_get_body_fd_for_mmap |
