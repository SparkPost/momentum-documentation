...
| [Prev](conf.ref.max_resident_messages.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.max_retries.php) |
...
| [Prev](conf.ref.max_resident_messages.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.max_retries.php) |
