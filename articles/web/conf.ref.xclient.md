...
| xclient |
| [Prev](conf.ref.worker_io_concurrency.php)  | 9.2. Configuration Files and Option Details |  [Next](cluster.ref.php) |
...
| [Prev](conf.ref.worker_io_concurrency.php)  | [Up](conf.ref.files.php) |  [Next](cluster.ref.php) |
| worker_io_concurrency  | [Table of Contents](index.php) |  Chapter 10. Cluster Configuration Reference |
