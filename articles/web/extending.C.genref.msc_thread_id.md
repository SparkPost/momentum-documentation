...
| msc_thread_id |
| [Prev](extending.C.genref.jlog_repair_datafile.php)  | Chapter 17. C API Reference |  [Next](extending.C.genref.register_smtp_client_state.php) |

<a name="extending.C.genref.msc_thread_id"></a>
## Name
...
`int <var class="pdparam">thread_id_len</var>`;<a name="idp20225216"></a>
## Description
...
| [Prev](extending.C.genref.jlog_repair_datafile.php)  | [Up](extending.C.ref.php) |  [Next](extending.C.genref.register_smtp_client_state.php) |
| jlog_repair_datafile  | [Table of Contents](index.php) |  register_smtp_client_state |
