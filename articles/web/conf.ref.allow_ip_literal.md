...
| allow_ip_literal |
| [Prev](conf.ref.alias_schemes.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.allow_null_envelope_sender.php) |
...
| [Prev](conf.ref.alias_schemes.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.allow_null_envelope_sender.php) |
