...
| [Prev](extending.hooks.core.get_outbound_tls_parameters.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.get_received_header_text.php) |

<a name="extending.hooks.core.get_protocol_string_for_trace_headers"></a>
## Name
...
`accept_construct * <var class="pdparam">ac</var>`;
`validate_context * <var class="pdparam">ctx</var>`;
`email_message * <var class="pdparam">mess</var>`;<a name="idp21422512"></a>
## Description

The `get_protocol_string_for_trace_headers` hook allows modules to customize the transmission type string that is used when ecelerity builds the Received: header. The default behaviour is to observe RFC 2821 and RFC 3848\. If your hook wants to override the default, then it should return the desired string. If it wants to take no action, return NULL; the default will then be used. The string that you return is assumed to be in static storage; the caller of this hook will not attempt to free it.

| [Prev](extending.hooks.core.get_outbound_tls_parameters.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.get_received_header_text.php) |
| get_outbound_tls_parameters  | [Table of Contents](index.php) |  get_received_header_text |
