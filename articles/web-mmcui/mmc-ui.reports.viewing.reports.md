...
| 1.2. Viewing Your Reports |
| [Prev](mmc-ui.reports.php)  | Chapter 1. Reports and Engagement Tracking |  [Next](mmc-ui.reports.evaluating.campaign.performance.php) |

## 1.2. Viewing Your Reports

After you have selected your metrics and filters, view your reports by going to the corresponding sections as described in [Figure 1.1, “Navigating Reports”](mmc-ui.reports.php#figure_navigation_menu "Figure 1.1. Navigating Reports"). The UI generates all the reports using the filters that you selected in the Summary section with the exception of the Engagement section. The Engagement section only supports the time period, campaign, and template filters.

### Note

The graphs in the UI depend on your specific messaging solution including configuration. For example, there will be no entries in the 10+ bar of the graph shown in [Figure 1.14, “Accepted Report”](mmc-ui.reports.viewing.reports.php#figure_accepted_report "Figure 1.14. Accepted Report") if the corresponding option is set for less than ten. For details about your configuration, contact your Message Systems representative.
...
**1.2.1.1. Analyzing Bounces by Type and by Category**
...
If you are transitioning from an Email Servicer Provider (ESP), you may tend to classify bounces as either hard or soft. SparkPost Elite provides more detailed bounce category analysis/mapping, including Block, Hard, Admin, Soft, and Undetermined.
...
*   Admin - Internal bounces that typically mean the message failed due to policy (Admin Failure) or is a subscribe request (Subscribe). Admin bounces are rejected directly by the SparkPost Elite server.
...
These classifications correspond to SparkPost Elite's [Bounce Classification Codes](https://support.messagesystems.com/docs/web-mmctutorials/bounce_logger.classification.codes.php).

[Figure 1.11, “Bounce Rates By Type and By Category”](mmc-ui.reports.viewing.reports.php#figure_bounces_by_category "Figure 1.11. Bounce Rates By Type and By Category") shows an example of the Block category expanded.

<a name="figure_bounces_by_category"></a>

**Figure 1.11. Bounce Rates By Type and By Category**
...
### 1.2.2. Rejections Report

Messages injected into SparkPost Elite can be rejected due to policy or technical reasons such as missing data. The Rejections report gives details about those rejections including rejection rate and the particular reasons why the messages were rejected. [Figure 1.13, “Rejections Report”](mmc-ui.reports.viewing.reports.php#figure_rejections_report "Figure 1.13. Rejections Report") shows an example report.

<a name="figure_rejections_report"></a>

**Figure 1.13. Rejections Report**
...
*   Injected - Messages either injected to or received by SparkPost Elite
...
Rejection Rate can be used to gauge the performance of your inbound messages. A lower rate shows that more of your messages are being successfully injected into SparkPost Elite.

**1.2.2.1. Viewing Rejection Reasons**

SparkPost Elite accepts messages for delivery using SMTP, ECStream, or HTTP. If a message is rejected, it is assigned a rejection reason that falls into one of three categories. The lower area of the Rejections report includes a table listing the rejection reasons along with their corresponding category, as shown in [Figure 1.13, “Rejections Report”](mmc-ui.reports.viewing.reports.php#figure_rejections_report "Figure 1.13. Rejections Report").
...
*   Category - One of three rejection categories for the given reason:
    ...
    *   Policy Rejection - Messages that were received by SparkPost Elite over SMTP or ECStream but were rejected due to policy

    *   Generation Rejection - Messages that were injected into SparkPost Elite over HTTP but were rejected due to policy
...
Note that the Rejection categories are also considered Admin Failures in the Bounces report. For details about Admin Failures, see [Section 1.2.1, “Bounces Report”](mmc-ui.reports.viewing.reports.php#mmc-ui.reports.bounces.report "1.2.1. Bounces Report").
...
### 1.2.3. Accepted Report

In any messaging campaign, you want your messages delivered and delivered quickly. Using the report provided in the Accepted section, you can view details about how many of your messages were accepted, the average delivery time and message size, and the number of delivery attempts required. [Figure 1.14, “Accepted Report”](mmc-ui.reports.viewing.reports.php#figure_accepted_report "Figure 1.14. Accepted Report") shows an example report.

<a name="figure_accepted_report"></a>

**Figure 1.14. Accepted Report**
...
*   Sent - Messages that SparkPost Elite attempted to deliver, which includes both Deliveries and In-Band Bounces
...
**1.2.3.1. Viewing Accepted Statistics**

The Accepted Stats area of this report provides average delivery times and message size, as shown in [Figure 1.14, “Accepted Report”](mmc-ui.reports.viewing.reports.php#figure_accepted_report "Figure 1.14. Accepted Report"). The following metrics are displayed:
...
**1.2.3.2. Analyzing Accepted Rates by Attempt**

The Accepted Rate given in the upper area of this report includes all messages that were accepted, regardless of the number of times delivery was attempted. The bar graph, shown in [Figure 1.14, “Accepted Report”](mmc-ui.reports.viewing.reports.php#figure_accepted_report "Figure 1.14. Accepted Report"), breaks down Accepted Rate by number of attempts.
...
### 1.2.4. Delayed Report

Temporary failures can cause your messages to be delayed. The report provided in the Delayed section includes details about the number of delayed messages and the reasons why they were delayed. [Figure 1.15, “Delayed Report”](mmc-ui.reports.viewing.reports.php#figure_delayed_report "Figure 1.15. Delayed Report") shows an example report.

<a name="figure_delayed_report"></a>

**Figure 1.15. Delayed Report**
...
| [Prev](mmc-ui.reports.php)  | [Up](mmc-ui.reports.php) |  [Next](mmc-ui.reports.evaluating.campaign.performance.php) |
| Chapter 1. Reports and Engagement Tracking  | [Table of Contents](index.php) |  1.3. Evaluating Your Campaign Performance |
