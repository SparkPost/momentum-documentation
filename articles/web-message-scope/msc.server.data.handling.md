...
| 6.9. Handling Data with GIMME |
| [Prev](msc.server.error.conditions.php)  | Chapter 6. Message Scope Server |  [Next](msc.lucene.query.php) |
...
| [Prev](msc.server.error.conditions.php)  | [Up](msc.server.php) |  [Next](msc.lucene.query.php) |
| 6.8. Error Conditions  | [Table of Contents](index.php) |  Chapter 7. Advanced Search Syntax |
