...
| Preface |
| [Prev](index.php)  |   |  [Next](msc.intro.php) |
...
*   `Text in this style` is used when referring to file names. For example, "The `pe2.conf` file is used to configure ".
...
/opt/msys/pe2/sbin/pe2batch --config *`/path/to/other/config/file`* \
  --save_dir *`/path/to/successful/bulk/insert/logs`*
### Feedback
...
| [Prev](index.php)  |   |  [Next](msc.intro.php) |
| Message Scope Reference  | [Table of Contents](index.php) |  Chapter 1. Introduction to Message Scope |
