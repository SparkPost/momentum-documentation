...
| body_assignment |
| [Prev](hooks.restinj.php)  | Chapter 66. Hooks in the restinj Scope |  [Next](hooks.restinj.json_request.php) |
...
`struct json_object * <var class="pdparam">json_req</var>`;
`struct json_object * <var class="pdparam">json_recip</var>`;
`const char * <var class="pdparam">templ</var>`;<a name="idp10342832"></a>
## Description
...
| [Prev](hooks.restinj.php)  | [Up](hooks.restinj.php) |  [Next](hooks.restinj.json_request.php) |
| Chapter 66. Hooks in the restinj Scope  | [Table of Contents](index.php) |  json_request |
