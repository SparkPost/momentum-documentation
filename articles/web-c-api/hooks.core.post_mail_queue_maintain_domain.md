...
| [Prev](hooks.core.post_initiate_connection_smtp.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.post_read_smtp.php) |
...
`domain_record * <var class="pdparam">dr</var>`;
`struct timeval * <var class="pdparam">now</var>`;
`int * <var class="pdparam">rv</var>`;<a name="idp8910352"></a>
## Description
...
| [Prev](hooks.core.post_initiate_connection_smtp.php)  | [Up](hooks.core.php) |  [Next](hooks.core.post_read_smtp.php) |
