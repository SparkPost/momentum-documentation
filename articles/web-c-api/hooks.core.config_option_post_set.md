...
| [Prev](hooks.core.config_get_message_routing_domain.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.config_option_pre_set.php) |
...
`ec_config_header * <var class="pdparam">cfghdr</var>`;
`ec_config_option * <var class="pdparam">opt</var>`;
`void ** <var class="pdparam">container</var>`;<a name="idp10498112"></a>
## Description

This hook is called after successfully setting a config option.

| [Prev](hooks.core.config_get_message_routing_domain.php)  | [Up](hooks.core.php) |  [Next](hooks.core.config_option_pre_set.php) |
| config_get_message_routing_domain  | [Table of Contents](index.php) |  config_option_pre_set |
