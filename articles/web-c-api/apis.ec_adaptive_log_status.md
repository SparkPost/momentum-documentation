...
| ec_adaptive_log_status |
| [Prev](apis.ec_adaptive_log_config.php)  | Chapter 2. Adaptive Functions |  [Next](apis.ec_adaptive_logf.php) |
...
`int <var class="pdparam">status</var>`;<a name="idp1456944"></a>
## Description
...
| [Prev](apis.ec_adaptive_log_config.php)  | [Up](adaptive.php) |  [Next](apis.ec_adaptive_logf.php) |
| ec_adaptive_log_config  | [Table of Contents](index.php) |  ec_adaptive_logf |
