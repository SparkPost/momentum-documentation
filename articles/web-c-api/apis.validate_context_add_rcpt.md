...
| validate_context_add_rcpt |
| [Prev](validate.php)  | Chapter 56. Validation Context Functions |  [Next](apis.validate_context_can_modify_rcpts.php) |
...
`int <var class="pdparam">uniq</var>`;<a name="idp36836112"></a>
## Description
...
| [Prev](validate.php)  | [Up](validate.php) |  [Next](apis.validate_context_can_modify_rcpts.php) |
| Chapter 56. Validation Context Functions  | [Table of Contents](index.php) |  validate_context_can_modify_rcpts |
