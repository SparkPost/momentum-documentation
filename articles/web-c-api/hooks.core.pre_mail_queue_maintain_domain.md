...
| [Prev](hooks.core.pre_event_close.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.pre_mail_queue_message_requeue.php) |
...
`domain_record * <var class="pdparam">dr</var>`;
`struct timeval * <var class="pdparam">now</var>`;
`int * <var class="pdparam">rv</var>`;<a name="idp18054192"></a>
## Description
...
| [Prev](hooks.core.pre_event_close.php)  | [Up](hooks.core.php) |  [Next](hooks.core.pre_mail_queue_message_requeue.php) |
