...
| [Prev](apis.ec_ptr_array_remove.php)  | Chapter 39. Pointer Array Functions |  [Next](rfc.php) |
...
`void * <var class="pdparam">elt</var>`;<a name="idp30823216"></a>
## Description
...
| [Prev](apis.ec_ptr_array_remove.php)  | [Up](ptr_array.php) |  [Next](rfc.php) |
| ec_ptr_array_remove  | [Table of Contents](index.php) |  Chapter 40. RFC Functions |
