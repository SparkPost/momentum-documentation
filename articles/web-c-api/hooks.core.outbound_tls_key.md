...
| outbound_tls_key |
| [Prev](hooks.core.outbound_tls_ciphers.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.outbound_tls_verify.php) |
...
`email_message * <var class="pdparam">message</var>`;<a name="idp5037072"></a>
## Description

This hook allows a client key file to be specified for a given email message.

| [Prev](hooks.core.outbound_tls_ciphers.php)  | [Up](hooks.core.php) |  [Next](hooks.core.outbound_tls_verify.php) |
