...
| ec_bag_remove |
| [Prev](apis.ec_bag_put.php)  | Chapter 5. Bag Functions |  [Next](base64.php) |
...
`const char * <var class="pdparam">typedname</var>`;<a name="idp19924080"></a>
## Description
...
| [Prev](apis.ec_bag_put.php)  | [Up](bag.php) |  [Next](base64.php) |
| ec_bag_put  | [Table of Contents](index.php) |  Chapter 6. Base64 Encode/Decode and Related Functions |
