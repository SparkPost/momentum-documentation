...
| [Prev](hooks.core.pre_swap_out_meta.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.rfc3464_inline_message_fragment.php) |
...
`connection_handle * <var class="pdparam">connh</var>`;
`domain_record * <var class="pdparam">src</var>`;
`domain_record * <var class="pdparam">dest</var>`;<a name="idp16106848"></a>
## Description
...
| [Prev](hooks.core.pre_swap_out_meta.php)  | [Up](hooks.core.php) |  [Next](hooks.core.rfc3464_inline_message_fragment.php) |
