...
| join |
| [Prev](hooks.msgc.get_private_name.php)  | Chapter 64. Hooks in the msgc Scope |  [Next](hooks.msgc.membership_subscribe.php) |
...
`u_int16_t <var class="pdparam">group_len</var>`;
`const char * <var class="pdparam">capabilities</var>`;
`u_int16_t <var class="pdparam">capabilities_len</var>`;<a name="idp11660960"></a>
## Description
...
| [Prev](hooks.msgc.get_private_name.php)  | [Up](hooks.msgc.php) |  [Next](hooks.msgc.membership_subscribe.php) |
| get_private_name  | [Table of Contents](index.php) |  membership_subscribe |
