...
| [Prev](apis.ec_httpsrv_response_status_ok.php)  | Chapter 28. httpsrv Functions |  [Next](apis.ec_httpsrv_response_status_set_std.php) |
...
`const char * <var class="pdparam">message</var>`;<a name="idp25681136"></a>
## Description
...
You will typically want to use [ec_httpsrv_response_status_set_std](apis.ec_httpsrv_response_status_set_std.php "ec_httpsrv_response_status_set_std") instead of this function, as it will set up Connection headers and compression.

| [Prev](apis.ec_httpsrv_response_status_ok.php)  | [Up](httpsrv.php) |  [Next](apis.ec_httpsrv_response_status_set_std.php) |
| ec_httpsrv_response_status_ok  | [Table of Contents](index.php) |  ec_httpsrv_response_status_set_std |
