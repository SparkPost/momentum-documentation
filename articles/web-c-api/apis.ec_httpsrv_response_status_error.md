...
| ec_httpsrv_response_status_error |
| [Prev](apis.ec_httpsrv_response_status_denied.php)  | Chapter 28. httpsrv Functions |  [Next](apis.ec_httpsrv_response_status_not_found.php) |
...
`const char * <var class="pdparam">type</var>`;<a name="idp25625504"></a>
## Description
...
| [Prev](apis.ec_httpsrv_response_status_denied.php)  | [Up](httpsrv.php) |  [Next](apis.ec_httpsrv_response_status_not_found.php) |
| ec_httpsrv_response_status_denied  | [Table of Contents](index.php) |  ec_httpsrv_response_status_not_found |
