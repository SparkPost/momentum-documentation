...
| ec_base64_encode_to_string |
| [Prev](apis.ec_base64_encode_string_to_string.php)  | Chapter 6. Base64 Encode/Decode and Related Functions |  [Next](apis.ec_convert_buffer.php) |
...
`int <var class="pdparam">fold</var>`;<a name="idp20051968"></a>
## Description
...
| [Prev](apis.ec_base64_encode_string_to_string.php)  | [Up](base64.php) |  [Next](apis.ec_convert_buffer.php) |
| ec_base64_encode_string_to_string  | [Table of Contents](index.php) |  ec_convert_buffer |
