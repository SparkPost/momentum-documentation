...
| ec_hex_decode |
| [Prev](apis.ec_gethostname.php)  | Chapter 55. Utility Functions |  [Next](apis.ec_hex_encode.php) |
...
`size_t <var class="pdparam">dest_len</var>`;<a name="idp36478288"></a>
## Description
...
| [Prev](apis.ec_gethostname.php)  | [Up](utility.php) |  [Next](apis.ec_hex_encode.php) |
| ec_gethostname  | [Table of Contents](index.php) |  ec_hex_encode |
