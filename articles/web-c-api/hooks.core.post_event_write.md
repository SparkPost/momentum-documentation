...
| post_event_write |
| [Prev](hooks.core.post_event_read.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.post_generate_rfc3464_message.php) |
...
`Event * <var class="pdparam">e</var>`;
`const char * <var class="pdparam">buf</var>`;
`ssize_t <var class="pdparam">buflen</var>`;<a name="idp18224576"></a>
## Description

*`post_event_write`* is called immediately after a successful write on the Event *`e`* if *`e->trace`* is true.

| [Prev](hooks.core.post_event_read.php)  | [Up](hooks.core.php) |  [Next](hooks.core.post_generate_rfc3464_message.php) |
