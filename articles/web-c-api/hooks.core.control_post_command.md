...
| [Prev](hooks.core.control_allow_writable_config2.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.control_post_control.php) |
...
`command_construct * <var class="pdparam">cc</var>`;
`string * <var class="pdparam">response</var>`;<a name="idp745536"></a>
## Description
...
| [Prev](hooks.core.control_allow_writable_config2.php)  | [Up](hooks.core.php) |  [Next](hooks.core.control_post_control.php) |
