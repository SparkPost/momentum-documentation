...
| http_uri |
| [Prev](conf.ref.http_method.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.http_version.php) |
...
| [Prev](conf.ref.http_method.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.http_version.php) |
