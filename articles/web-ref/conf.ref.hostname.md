...
| hostname |
| [Prev](conf.ref.host_failure_retry.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.http_basic_auth.php) |
...
| [Prev](conf.ref.host_failure_retry.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.http_basic_auth.php) |
| host_failure_retry  | [Table of Contents](index.php) |  http_basic_auth |
