...
| tls_ca |
| [Prev](conf.ref.tls_allow_renegotiation.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.tls_certificate.php) |
...
| [Prev](conf.ref.tls_allow_renegotiation.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.tls_certificate.php) |
