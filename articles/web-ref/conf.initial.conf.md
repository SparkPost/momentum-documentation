...
| [Prev](conf.multi-core.php)  | Chapter 2. Configuration |  [Next](ecelerity.conf.fallback.php) |
...
*   [ESMTP Listeners and Authentication](ecelerity.conf.php#ecelerity.conf3.esmtp.authentication "ESMTP_Listener and Authentication")

Many other parameters can be modified. There is more information on this topic throughout this manual.

| [Prev](conf.multi-core.php)  | [Up](conf.php) |  [Next](ecelerity.conf.fallback.php) |
| 2.4. Configuring for Multiple Event Loops in Momentum 3.6  | [Table of Contents](index.php) |  2.6. Configuration Scopes and Fallback |
