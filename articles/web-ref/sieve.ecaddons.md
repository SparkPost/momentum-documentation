...
More information on configuring the sieve module can be found in [Section 14.64, “sieve – The Sieve Module”](modules.sieve.php "14.64. sieve – The Sieve Module").
...
For more information about the spf modules see [Section 14.69, “spf Modules – spf_macros, spf_v1 and senderid (SPF v2)”](modules.spf.php "14.69. spf Modules – spf_macros, spf_v1 and senderid (SPF v2)").
...
A number of non-standard tests and actions are made available for you in Sieve++; a complete reference can be found in [Chapter 16, *Sieve++ Function Reference*](sieve.ref3.php "Chapter 16. Sieve++ Function Reference") .
