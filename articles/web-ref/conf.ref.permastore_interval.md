...
| permastore_interval |
| [Prev](conf.ref.pcre_cache_ttl.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.pidfile.php) |
...
| [Prev](conf.ref.pcre_cache_ttl.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.pidfile.php) |
