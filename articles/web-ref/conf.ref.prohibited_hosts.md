...
| prohibited_hosts |
| [Prev](conf.ref.privileges.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.rcptto_timeout.php) |
...
| [Prev](conf.ref.privileges.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.rcptto_timeout.php) |
| privileges  | [Table of Contents](index.php) |  rcptto_timeout |
