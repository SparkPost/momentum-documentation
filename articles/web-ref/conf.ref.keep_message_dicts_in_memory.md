...
| [Prev](conf.ref.inline_transfail_processing.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.large_message_threshold.php) |
...
In some circumstances using the Lua function [msg:routing_domain](lua.ref.msg_routing_domain.php "msg:routing_domain") may cause Momentum to "watchdog"—to become unresponsive and restart. To alleviate this, set `keep_message_dicts_in_memory` to `true`.
...
| [Prev](conf.ref.inline_transfail_processing.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.large_message_threshold.php) |
