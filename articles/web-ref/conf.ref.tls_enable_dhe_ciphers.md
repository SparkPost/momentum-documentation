...
| [Prev](conf.ref.tls_dhparams_file.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.tls_client_ca.php) |
...
| [Prev](conf.ref.tls_dhparams_file.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.tls_client_ca.php) |
| tls_dhparams_file  | [Table of Contents](index.php) |  tls_client_ca |
