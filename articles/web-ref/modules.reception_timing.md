...
| [Prev](modules.postfix_logger.php)  | Chapter 14. Modules Reference |  [Next](modules.response_transcode.php) |
...
You may also wish to add the chunk_logger log file to `ec_rotate.conf`, to ensure that it is rotated daily. For more information, see [Section 14.15, “chunk_logger – Asynchronous Logging”](modules.chunk_logger.php "14.15. chunk_logger – Asynchronous Logging") and [ec_rotate](executable.ec_rotate.php "ec_rotate").
...
| 14.56. postfix_logger – Postfix-Compatible Logging  | [Table of Contents](index.php) |  14.58. response_transcode – Module |
