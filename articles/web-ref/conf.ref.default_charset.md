...
| default_charset |
| [Prev](conf.ref.default_binding.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.delay_dsn_max_retry_interval.php) |
...
| [Prev](conf.ref.default_binding.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.delay_dsn_max_retry_interval.php) |
