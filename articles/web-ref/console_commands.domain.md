...
| domain |
| [Prev](console_commands.dns_cache.php)  | 12.2. System Console Commands |  [Next](console_commands.domain_all.php) |
...
Note that the default binding is shown. For more information about this binding see [the section called “The "default" Binding”](conf.ref.binding.php#conf.ref.binding.default "The "default" Binding"). In a cluster configuration the `#mmove` binding is also displayed. This built-in binding shows messages that have moved between nodes.
...
| [Prev](console_commands.dns_cache.php)  | [Up](console.commands.non-module.php) |  [Next](console_commands.domain_all.php) |
