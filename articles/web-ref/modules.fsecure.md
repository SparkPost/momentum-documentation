...
| [Prev](modules.fbl.php)  | Chapter 14. Modules Reference |  [Next](modules.host_fingerprint.php) |
...
For a list of the configuration options that this module shares with other antivirus modules see [Section 14.5.1, “antivirus Configuration”](modules.antivirus.php#modules.antivirus.configuration "14.5.1. antivirus Configuration").
...
| [Prev](modules.fbl.php)  | [Up](modules.php) |  [Next](modules.host_fingerprint.php) |
| 14.34. fbl – Feedback Loop Module  | [Table of Contents](index.php) |  14.36. fingerprint – Host Fingerprinting |
