...
| [Prev](modules.persistio.php)  | Chapter 14. Modules Reference |  [Next](modules.pipe_transport.php) |
...
[Section 2.1.5.1, “The `environment` File”](conf.ecelerity.conf.php#conf.environment.file "2.1.5.1. The environment File")

| [Prev](modules.persistio.php)  | [Up](modules.php) |  [Next](modules.pipe_transport.php) |
| 14.53. persist_io – Persistent IO Wrapper  | [Table of Contents](index.php) |  14.55. pipe_transport – Module |
