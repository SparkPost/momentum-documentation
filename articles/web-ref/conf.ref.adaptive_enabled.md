...
| adaptive_enabled |
| [Prev](conf.ref.adaptive_backstore_riak.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.adaptive_scope.php) |
...
| [Prev](conf.ref.adaptive_backstore_riak.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.adaptive_scope.php) |
