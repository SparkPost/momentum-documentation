...
| 14.47. msgc – Modules |
| [Prev](modules.maildir.php)  | Chapter 14. Modules Reference |  [Next](modules.mxip.php) |
...
As with other modules, you can set configuration options from the web UI, by changing configuration files or at runtime as described in [config](console_commands.config.php "config").
...
The debug level for this module. The default value for this option is `ERROR`. For more information see [Table 9.28, “Debug levels”](conf.ref.debug_flags.php#conf.ref.debug.levels "Table 9.28. Debug levels").
...
As with other listeners, a listen scope is defined within the msgcserver_listener. This scope defines the port that the listener listens on. For more information about listen scopes see [the section called “Listeners”](ecelerity.conf.php#ecelerity.conf3.listeners "Listeners").
...
| [Prev](modules.maildir.php)  | [Up](modules.php) |  [Next](modules.mxip.php) |
| 14.46. maildir – Maildir Delivery Support  | [Table of Contents](index.php) |  14.48. mxip - IP Addresses In MX Records |
