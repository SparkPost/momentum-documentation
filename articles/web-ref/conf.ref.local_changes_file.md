...
| local_changes_file |
| [Prev](conf.ref.lmtp_port.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.local_changes_only.php) |
...
| [Prev](conf.ref.lmtp_port.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.local_changes_only.php) |
