...
| [Prev](conf.ref.delay_dsn_retry_interval.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.delayed_queue_scan_interval.php) |
...
| [Prev](conf.ref.delay_dsn_retry_interval.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.delayed_queue_scan_interval.php) |
