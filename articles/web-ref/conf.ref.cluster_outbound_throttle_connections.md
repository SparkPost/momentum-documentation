...
The cluster module must be configured with the outbound throttle parameters as defined here: [Section 7.7.1.8, “Shared Outbound Throttles”](cluster.config.replication.php#cluster.replication.outbound_throttles "7.7.1.8. Shared Outbound Throttles")
