...
| node:tostring |
| [Prev](lua.ref.xml.node_name.php)  | 15.2. Lua Functions |  [Next](lua.ref.xml.node_unlink.php) |
...
The `print` function will automatically convert a node to string so the use of `child:tostring` in [Example 15.84, “node:tostring example”](lua.ref.xml.node_tostring.php#lua.ref.xml.node_tostring.example "Example 15.84. node:tostring example") is not strictly necessary.
