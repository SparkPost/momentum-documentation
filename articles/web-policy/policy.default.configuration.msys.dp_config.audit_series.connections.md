...
| 4.8. msys.dp_config.audit_series.connections |
| [Prev](policy.default.configuration.msys.dp_config.audit_series.invalid_smtp_auth.php)  | Chapter 4. Configuration Details |  [Next](policy.default.configuration.msys.dp_config.audit_series.mailfrom.php) |
...
The threshold for this specific CIDR mask. When this threshold is exceeded code `421` is issued along with the message `connection rate limit exceeded`.
...
| [Prev](policy.default.configuration.msys.dp_config.audit_series.invalid_smtp_auth.php)  | [Up](policy.default.configuration.php) |  [Next](policy.default.configuration.msys.dp_config.audit_series.mailfrom.php) |
| 4.7. msys.dp_config.audit_series.invalid_smtp_auth  | [Table of Contents](index.php) |  4.9. msys.dp_config.audit_series.mailfrom |
