...
| license |
| [Prev](conf.ref.legacy_message_threshold.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.lmtp_port.php) |
...
`license = "/opt/ecelerity/etc/license"`
...
| [Prev](conf.ref.legacy_message_threshold.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.lmtp_port.php) |
