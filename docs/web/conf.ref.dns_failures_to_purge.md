...
| [Prev](conf.ref.dns_expire_interval.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.domain.php) |
...
| [Prev](conf.ref.dns_expire_interval.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.domain.php) |
| dns_expire_interval  | [Table of Contents](index.php) |  domain |
