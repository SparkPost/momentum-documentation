...
| [Prev](extending.hooks.core.inbound_smtp_tls_verify_callback.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.inc_outbound_conn_throttle.php) |

<a name="extending.hooks.core.inc_inbound_connections"></a>
## Name
...
`char * <var class="pdparam">conntype</var>`;
`int <var class="pdparam">fd</var>`;
`accept_construct * <var class="pdparam">ac</var>`;<a name="idp21493600"></a>
## Description
...
| [Prev](extending.hooks.core.inbound_smtp_tls_verify_callback.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.inc_outbound_conn_throttle.php) |
