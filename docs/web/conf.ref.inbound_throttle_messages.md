...
| [Prev](conf.ref.idle_timeout.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.inline_transfail_processing.php) |
...
inbound_throttle_messages is valid in the global scope.

| [Prev](conf.ref.idle_timeout.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.inline_transfail_processing.php) |
| idle_timeout  | [Table of Contents](index.php) |  inline_transfail_processing |
