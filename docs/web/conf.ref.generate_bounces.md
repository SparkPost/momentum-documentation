...
| generate_bounces |
| [Prev](conf.ref.gateway.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.generate_bounces_for_multi_recipient_policy_rejections.php) |
...
| [Prev](conf.ref.gateway.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.generate_bounces_for_multi_recipient_policy_rejections.php) |
