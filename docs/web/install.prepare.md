...
| [Prev](install.ports.php)  | Chapter 1. Installation |  [Next](install.os-specific.php) |
...
The base path for the spool directory used in all examples throughout this manual is `/var/spool/ecelerity`. Under Windows, which has no `/var` directory, you may instead use `/opt/ecelerity/var/spool/ecelerity`; the example configuration file is pre-configured with this as a working default. *Note: Momentum is no longer supported on Windows.* 
...
### 1.3.2. The NFS File System and Momentum
...
### 1.3.4. Configuring Domain Name Service
...
### 1.3.5. Stop Any MTAs That May be Running
...
Impact: None.
```
**1.3.5.1. Stopping and Removing Mail Servers**
...
### 1.3.7. Installing the License File
...
**1.3.7.2. Connectivity to Message Systems' License Server**
...
**1.3.7.3. Access via an HTTP Proxy**
...
**1.3.7.4. Machines with Multiple Interfaces**
...
| [Prev](install.ports.php)  | [Up](install.php) |  [Next](install.os-specific.php) |
| 1.2. Ports Used by Momentum  | [Table of Contents](index.php) |  1.4. Operating System Specific Preparation |
