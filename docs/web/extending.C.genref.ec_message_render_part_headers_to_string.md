...
| ec_message_render_part_headers_to_string |
| [Prev](extending.C.genref.ec_message_render_meta_to_string.php)  | Chapter 17. C API Reference |  [Next](extending.C.genref.ec_message_render_part_to_string.php) |

<a name="extending.C.genref.ec_message_render_part_headers_to_string"></a>
## Name
...
`int <var class="pdparam">flags</var>`;<a name="idp19650656"></a>
## Description
...
| [Prev](extending.C.genref.ec_message_render_meta_to_string.php)  | [Up](extending.C.ref.php) |  [Next](extending.C.genref.ec_message_render_part_to_string.php) |
| ec_message_render_meta_to_string  | [Table of Contents](index.php) |  ec_message_render_part_to_string |
