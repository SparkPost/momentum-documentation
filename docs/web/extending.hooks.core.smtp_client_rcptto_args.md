...
| [Prev](extending.hooks.core.smtp_client_mailfrom_args.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.smtp_client_xclient_args.php) |

<a name="extending.hooks.core.smtp_client_rcptto_args"></a>
## Name
...
`delivery_construct * <var class="pdparam">dc</var>`;
`smtp_client_args * <var class="pdparam">args</var>`;<a name="idp22877488"></a>
## Description
...
| [Prev](extending.hooks.core.smtp_client_mailfrom_args.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.smtp_client_xclient_args.php) |
| smtp_client_mailfrom_args  | [Table of Contents](index.php) |  smtp_client_xclient_args |
