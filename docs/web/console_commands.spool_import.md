...
As of version 2.2.2.32, a fresh message queue id is created for every imported message.

**Configuration Change. ** This feature is available starting from Momentum 2.2.2.32.

You can configure the ec_logger module to log import events as described in [Section 14.26, “ec_logger – Momentum-Style Logging”](modules.ec_logger.php "14.26. ec_logger – Momentum-Style Logging"). Alternatively, you can implement a hook to record these events as you see fit.

<a name="idp10171600"></a>
## See Also
