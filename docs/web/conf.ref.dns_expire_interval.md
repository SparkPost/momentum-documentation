...
| dns_expire_interval |
| [Prev](conf.ref.dns_cache_purge_interval.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.dns_failures_to_purge.php) |
...
| [Prev](conf.ref.dns_cache_purge_interval.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.dns_failures_to_purge.php) |
