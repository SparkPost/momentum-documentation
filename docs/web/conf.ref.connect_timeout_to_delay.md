...
| [Prev](conf.ref.connect_timeout.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.connection_allocation_aggressiveness.php) |
...
| [Prev](conf.ref.connect_timeout.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.connection_allocation_aggressiveness.php) |
