...
| debug_flags |
| [Prev](conf.ref.date_header.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.default_binding.php) |
...
**Table 9.3. Subsystems and symbolic names**
...
**Configuration Change. ** The `START` subsystem is available as of version 2.2.2.30.
...
| [Prev](conf.ref.date_header.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.default_binding.php) |
| date_header  | [Table of Contents](index.php) |  default_binding |
