...
| [Prev](extending.hooks.core.inc_outbound_connections.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.log_attempt.php) |

<a name="extending.hooks.core.inc_outbound_mess_throttle"></a>
## Name
...
`int <var class="pdparam">binding_id</var>`;
`domain_record * <var class="pdparam">dr</var>`;<a name="idp21550016"></a>
## Description
...
| [Prev](extending.hooks.core.inc_outbound_connections.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.log_attempt.php) |
| inc_outbound_connections  | [Table of Contents](index.php) |  log_attempt |
