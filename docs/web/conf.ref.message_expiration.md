...
| message_expiration |
| [Prev](conf.ref.memory_hwm.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.messageid_header.php) |
...
| [Prev](conf.ref.memory_hwm.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.messageid_header.php) |
| memory_hwm  | [Table of Contents](index.php) |  messageid_header |
