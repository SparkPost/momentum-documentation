...
**Example 9.4. Privileges and Capabilities in a stand-alone configuration**
...
**Example 9.5. Privileges and Capabilities in a cluster configuration**
...
[chroot](conf.ref.chroot.php "chroot"), [user](conf.ref.user.php "user"), [supplemental_groups](conf.ref.supplemental_groups.php "supplemental_groups"), [user](conf.ref.user.php "user"),
