...
| hostname |
| [Prev](conf.ref.host_failure_retry.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.idle_timeout.php) |
...
| [Prev](conf.ref.host_failure_retry.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.idle_timeout.php) |
| host_failure_retry  | [Table of Contents](index.php) |  idle_timeout |
