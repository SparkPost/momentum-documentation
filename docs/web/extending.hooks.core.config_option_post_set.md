...
| [Prev](extending.hooks.core.config_get_routes_data_copy.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.config_option_pre_set.php) |

<a name="extending.hooks.core.config_option_post_set"></a>
## Name
...
`ec_config_header * <var class="pdparam">cfghdr</var>`;
`ec_config_option * <var class="pdparam">opt</var>`;
`void ** <var class="pdparam">container</var>`;<a name="idp20693008"></a>
## Description

This hook is called after successfully setting a config option.

| [Prev](extending.hooks.core.config_get_routes_data_copy.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.config_option_pre_set.php) |
| config_get_routes_data_copy  | [Table of Contents](index.php) |  config_option_pre_set |
