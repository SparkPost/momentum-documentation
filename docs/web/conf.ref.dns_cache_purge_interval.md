...
| [Prev](conf.ref.dkim.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.dns_expire_interval.php) |
...
| [Prev](conf.ref.dkim.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.dns_expire_interval.php) |
| dkim  | [Table of Contents](index.php) |  dns_expire_interval |
