...
| outbound_tls_key |
| [Prev](extending.hooks.core.outbound_tls_ciphers.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.outbound_tls_verify.php) |

<a name="extending.hooks.core.outbound_tls_key"></a>
## Name
...
`email_message * <var class="pdparam">message</var>`;<a name="idp22138192"></a>
## Description

This hook allows a client key file to be specified for a given email message.

| [Prev](extending.hooks.core.outbound_tls_ciphers.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.outbound_tls_verify.php) |
| outbound_tls_ciphers  | [Table of Contents](index.php) |  outbound_tls_verify |
