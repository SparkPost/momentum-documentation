...
| ec_ip_receptions |
| [Prev](sieve.ref.ec_ip_connections_cluster.php)  | Chapter 15. Sieve++ Function Reference |  [Next](sieve.ref.ec_ip_receptions_cluster.php) |
...
**Example 15.67. ec_ip_receptions example (first form)**
...
**Example 15.68. ec_ip_receptions example (second form)**
...
| [Prev](sieve.ref.ec_ip_connections_cluster.php)  | [Up](sieve.ref.php) |  [Next](sieve.ref.ec_ip_receptions_cluster.php) |
| ec_ip_connections_cluster  | [Table of Contents](index.php) |  ec_ip_receptions_cluster |
