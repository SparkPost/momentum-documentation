...
| remote_smtp_port |
| [Prev](conf.ref.relay_hosts.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.require_ehlo.php) |
...
| [Prev](conf.ref.relay_hosts.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.require_ehlo.php) |
