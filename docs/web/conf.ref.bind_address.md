...
The default for this option is `*`, which corresponds to `INADDR_ANY` ; the actual address used in that case is determined by the operating system kernel based on the destination address.
