...
| [Prev](conf.ref.messageid_header.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.min_dns_ttl.php) |
...
**Configuration Change. ** This feature is available starting from Momentum 2.2.2.31.
...
| [Prev](conf.ref.messageid_header.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.min_dns_ttl.php) |
| messageid_header  | [Table of Contents](index.php) |  min_dns_ttl |
