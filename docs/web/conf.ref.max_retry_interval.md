...
| max_retry_interval |
| [Prev](conf.ref.max_retries.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.max_timed_events_per_iter.php) |
...
| [Prev](conf.ref.max_retries.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.max_timed_events_per_iter.php) |
