...
| post_event_read |
| [Prev](extending.hooks.core.post_drop_privileges.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.post_event_write.php) |

<a name="extending.hooks.core.post_event_read"></a>
## Name
...
`Event * <var class="pdparam">e</var>`;
`const char * <var class="pdparam">buf</var>`;
`ssize_t <var class="pdparam">buflen</var>`;<a name="idp22281136"></a>
## Description

*`post_event_read`* is called immediately after a successful read on the Event *`e`* if *`e->trace`* is true.

| [Prev](extending.hooks.core.post_drop_privileges.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.post_event_write.php) |
