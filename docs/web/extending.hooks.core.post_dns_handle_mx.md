...
| post_dns_handle_mx |
| [Prev](extending.hooks.core.post_dns_handle_a.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.post_drop_privileges.php) |

<a name="extending.hooks.core.post_dns_handle_mx"></a>
## Name
...
`unsigned char * <var class="pdparam">abuf</var>`;
`int <var class="pdparam">alen</var>`;
`const char * <var class="pdparam">qdomain</var>`;<a name="idp22242832"></a>
## Description
...
| [Prev](extending.hooks.core.post_dns_handle_a.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.post_drop_privileges.php) |
