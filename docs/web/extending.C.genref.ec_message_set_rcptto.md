...
| [Prev](extending.C.genref.ec_message_set_next_attempt.php)  | Chapter 17. C API Reference |  [Next](extending.C.genref.ec_message_snapshot.php) |

<a name="extending.C.genref.ec_message_set_rcptto"></a>
## Name
...
`int <var class="pdparam">take_buffer</var>`;<a name="idp19836032"></a>
## Description
...
| [Prev](extending.C.genref.ec_message_set_next_attempt.php)  | [Up](extending.C.ref.php) |  [Next](extending.C.genref.ec_message_snapshot.php) |
| ec_message_set_next_attempt  | [Table of Contents](index.php) |  ec_message_snapshot |
