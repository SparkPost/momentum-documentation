...
| [Prev](extending.hooks.core.control_allow_writable_config.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.control_post_command.php) |

<a name="extending.hooks.core.control_allow_writable_config2"></a>
## Name
...
`const char * <var class="pdparam">argv[]</var>`;
`ec_control_context * <var class="pdparam">input</var>`;
`ec_control_context * <var class="pdparam">output</var>`;<a name="idp20806272"></a>
## Description
...
| [Prev](extending.hooks.core.control_allow_writable_config.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.control_post_command.php) |
