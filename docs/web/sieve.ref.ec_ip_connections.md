...
| ec_ip_connections |
| [Prev](sieve.ref.ec_interfaces.php)  | Chapter 15. Sieve++ Function Reference |  [Next](sieve.ref.ec_ip_connections_cluster.php) |
...
**Example 15.63. ec_ip_connections example (first form)**
...
**Example 15.64. ec_ip_connections example (second form)**
...
| [Prev](sieve.ref.ec_interfaces.php)  | [Up](sieve.ref.php) |  [Next](sieve.ref.ec_ip_connections_cluster.php) |
| ec_interfaces  | [Table of Contents](index.php) |  ec_ip_connections_cluster |
