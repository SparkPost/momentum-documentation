...
| rcptto_timeout |
| [Prev](conf.ref.prohibited_hosts.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.relay_domains.php) |
...
| [Prev](conf.ref.prohibited_hosts.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.relay_domains.php) |
| prohibited_hosts  | [Table of Contents](index.php) |  relay_domains |
