...
| post_dns_handle_a |
| [Prev](extending.hooks.core.post_conf.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.post_dns_handle_mx.php) |

<a name="extending.hooks.core.post_dns_handle_a"></a>
## Name
...
`unsigned char * <var class="pdparam">abuf</var>`;
`int <var class="pdparam">alen</var>`;
`const char * <var class="pdparam">qdomain</var>`;<a name="idp22219728"></a>
## Description
...
| [Prev](extending.hooks.core.post_conf.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.post_dns_handle_mx.php) |
| post_conf  | [Table of Contents](index.php) |  post_dns_handle_mx |
