...
| post_event_write |
| [Prev](extending.hooks.core.post_event_read.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.post_generate_rfc3464_message.php) |

<a name="extending.hooks.core.post_event_write"></a>
## Name
...
`Event * <var class="pdparam">e</var>`;
`const char * <var class="pdparam">buf</var>`;
`ssize_t <var class="pdparam">buflen</var>`;<a name="idp22302352"></a>
## Description

*`post_event_write`* is called immediately after a successful write on the Event *`e`* if *`e->trace`* is true.

| [Prev](extending.hooks.core.post_event_read.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.post_generate_rfc3464_message.php) |
| post_event_read  | [Table of Contents](index.php) |  post_generate_rfc3464_message |
