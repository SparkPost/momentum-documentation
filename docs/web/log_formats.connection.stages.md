...
| C.3. Connection Stages |
| [Prev](bounce_logger.classification.codes.php)  | Appendix C. Log Formats |  [Next](error-messages.php) |
...
| [Prev](bounce_logger.classification.codes.php)  | [Up](log_formats.php) |  [Next](error-messages.php) |
| C.2. Bounce Classification Codes  | [Table of Contents](index.php) |  Appendix D. Panic Log Errors |
