...
| advertize_esmtp_capability |
| [Prev](sieve.ref.address.php)  | Chapter 15. Sieve++ Function Reference |  [Next](sieve.ref.antivirus.php) |
...
**Example 15.3. advertize_esmtp_capability example**

`advertize_esmtp_capability "8bitmime"`
<a name="idp13171168"></a>
## See Also

[disable_esmtp_capability](sieve.ref.disable_esmtp_capability.php "disable_esmtp_capability")

| [Prev](sieve.ref.address.php)  | [Up](sieve.ref.php) |  [Next](sieve.ref.antivirus.php) |
| address  | [Table of Contents](index.php) |  antivirus |
