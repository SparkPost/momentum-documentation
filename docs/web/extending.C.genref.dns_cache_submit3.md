...
| dns_cache_submit3 |
| [Prev](extending.C.genref.dns_cache_submit2.php)  | Chapter 17. C API Reference |  [Next](extending.C.genref.ec_bag_addref.php) |

<a name="extending.C.genref.dns_cache_submit3"></a>
## Name
...
`ares_channel <var class="pdparam">mychannel</var>`;<a name="idp18626560"></a>
## Description
...
| [Prev](extending.C.genref.dns_cache_submit2.php)  | [Up](extending.C.ref.php) |  [Next](extending.C.genref.ec_bag_addref.php) |
| dns_cache_submit2  | [Table of Contents](index.php) |  ec_bag_addref |
