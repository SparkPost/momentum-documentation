...
| jlog_sanity_check |
| [Prev](executable.jlog_change_endian.php)  | 11.2. Executable Commands |  [Next](executable.mbuscfg.php) |
...
`/opt/ecelerity/bin/jlog_sanity_check.pl` { le | be } *`jlog`*
...
| [Prev](executable.jlog_change_endian.php)  | [Up](exe.commands.details.php) |  [Next](executable.mbuscfg.php) |
| jlog_change_endian  | [Table of Contents](index.php) |  mbuscfg |
