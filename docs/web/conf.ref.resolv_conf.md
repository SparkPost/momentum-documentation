...
| resolv_conf |
| [Prev](conf.ref.reserve_maintenance_interval.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.response_transcode_pattern.php) |
...
On Windows, Momentum will first check for `/opt/ecelerity/etc/resolv.conf`, and if it does not exist, will query DNS server information from the network interface configuration on the machine.
...
| [Prev](conf.ref.reserve_maintenance_interval.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.response_transcode_pattern.php) |
