...
| [Prev](extending.hooks.core.connection_goal.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.control_allow_writable_config.php) |

<a name="extending.hooks.core.connection_post_bind"></a>
## Name
...
`int <var class="pdparam">fd</var>`;
`struct sockaddr * <var class="pdparam">addr</var>`;
`int <var class="pdparam">addr_len</var>`;<a name="idp20760208"></a>
## Description
...
| [Prev](extending.hooks.core.connection_goal.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.control_allow_writable_config.php) |
