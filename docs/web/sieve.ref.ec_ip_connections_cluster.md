...
| [Prev](sieve.ref.ec_ip_connections.php)  | Chapter 15. Sieve++ Function Reference |  [Next](sieve.ref.ec_ip_receptions.php) |
...
**Configuration Change. ** This feature requires the inbound_audit module. See [Section 14.33, “inbound_audit – Inbound traffic analytics”](modules.inbound_audit.php "14.33. inbound_audit – Inbound traffic analytics") for more information.
...
**Example 15.65. ec_ip_connections_cluster example (first form)**
...
**Example 15.66. ec_ip_connections_cluster example (second form)**
...
| [Prev](sieve.ref.ec_ip_connections.php)  | [Up](sieve.ref.php) |  [Next](sieve.ref.ec_ip_receptions.php) |
