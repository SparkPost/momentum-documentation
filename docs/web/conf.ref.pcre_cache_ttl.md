...
| pcre_cache_ttl |
| [Prev](conf.ref.pcre_cache_size.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.pedantic_address_rules.php) |
...
| [Prev](conf.ref.pcre_cache_size.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.pedantic_address_rules.php) |
| pcre_cache_size  | [Table of Contents](index.php) |  pedantic_address_rules |
