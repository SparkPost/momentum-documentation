...
The HTTP I/O provider is very simple. It takes no configuration parameters and enabling it is accomplished by adding the following to your configuration:

<a name="example.http_io"></a>

**Example 14.51. http_io module**
...
| 14.30. fingerprint – Host Fingerprinting  | [Table of Contents](index.php) |  14.32. icu – ICU |
