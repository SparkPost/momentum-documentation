...
| [Prev](extending.hooks.core.premigrate_outbound_connection.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.server_esmtp_session_abort.php) |

<a name="extending.hooks.core.rfc3464_inline_message_fragment"></a>
## Name
...
`string * <var class="pdparam">response</var>`;
`ec_message * <var class="pdparam">message</var>`;
`dsn_actype <var class="pdparam">action</var>`;<a name="idp22812240"></a>
## Description
...
| [Prev](extending.hooks.core.premigrate_outbound_connection.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.server_esmtp_session_abort.php) |
