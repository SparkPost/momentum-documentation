...
| [Prev](extending.hooks.core.pre_event_close.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.pre_mail_queue_message_requeue.php) |

<a name="extending.hooks.core.pre_mail_queue_maintain_domain"></a>
## Name
...
`domain_record * <var class="pdparam">dr</var>`;
`struct timeval * <var class="pdparam">now</var>`;
`int * <var class="pdparam">rv</var>`;<a name="idp22681632"></a>
## Description
...
| [Prev](extending.hooks.core.pre_event_close.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.pre_mail_queue_message_requeue.php) |
| pre_event_close  | [Table of Contents](index.php) |  pre_mail_queue_message_requeue |
