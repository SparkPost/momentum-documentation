...
| [Prev](extending.hooks.core.control_shutdown_ex.php)  | Chapter 18. Hooks in the core scope |  [Next](extending.hooks.core.dec_outbound_connections.php) |

<a name="extending.hooks.core.dec_inbound_connections"></a>
## Name
...
`char * <var class="pdparam">conntype</var>`;
`int <var class="pdparam">fd</var>`;
`accept_construct * <var class="pdparam">ac</var>`;<a name="idp20959184"></a>
## Description
...
| [Prev](extending.hooks.core.control_shutdown_ex.php)  | [Up](extending.hooks.core.php) |  [Next](extending.hooks.core.dec_outbound_connections.php) |
| control_shutdown_ex  | [Table of Contents](index.php) |  dec_outbound_connections |
