...
| Appendix A. The `dp_config.lua` and `custom_policy.lua` Files |
| [Prev](policy.customize.php)  |   |  [Next](policy.appendix.custom_policy.lua.php) |
...
| [Prev](policy.customize.php)  |   |  [Next](policy.appendix.custom_policy.lua.php) |
| Chapter 5. Customizing Policy  | [Table of Contents](index.php) |  A.2. The `custom_policy.lua` File |
