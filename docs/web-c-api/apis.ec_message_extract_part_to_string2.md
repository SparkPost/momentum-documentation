...
| [Prev](apis.ec_message_extract_part_to_string.php)  | Chapter 34. Message Functions |  [Next](apis.ec_message_free.php) |
...
`const char * <var class="pdparam">desired_charset</var>`;<a name="idp28141872"></a>
## Description
...
| [Prev](apis.ec_message_extract_part_to_string.php)  | [Up](ec_message.php) |  [Next](apis.ec_message_free.php) |
| ec_message_extract_part_to_string  | [Table of Contents](index.php) |  ec_message_free |
