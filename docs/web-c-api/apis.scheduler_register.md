...
| scheduler_register |
| [Prev](apis.scheduler_recurrent_func_add.php)  | Chapter 41. Scheduler Functions |  [Next](apis.scheduler_reuse_connection.php) |
...
`ec_scheduler_impl * <var class="pdparam">ascheduler</var>`;<a name="idp31439632"></a>
## Description
...
| [Prev](apis.scheduler_recurrent_func_add.php)  | [Up](scheduler.php) |  [Next](apis.scheduler_reuse_connection.php) |
| scheduler_recurrent_func_add  | [Table of Contents](index.php) |  scheduler_reuse_connection |
