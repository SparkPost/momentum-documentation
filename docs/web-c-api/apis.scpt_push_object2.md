...
| scpt_push_object2 |
| [Prev](apis.scpt_push_object.php)  | Chapter 42. Scriptlet (and Alerting) Functions |  [Next](apis.scpt_push_object_and_allocate.php) |
...
`void * <var class="pdparam">object</var>`;<a name="idp31799552"></a>
## Description
...
<a name="idp31810720"></a>
## See Also

[Chapter 42, *Scriptlet (and Alerting) Functions*](script.php "Chapter 42. Scriptlet (and Alerting) Functions") 

| [Prev](apis.scpt_push_object.php)  | [Up](script.php) |  [Next](apis.scpt_push_object_and_allocate.php) |
| scpt_push_object  | [Table of Contents](index.php) |  scpt_push_object_and_allocate |
