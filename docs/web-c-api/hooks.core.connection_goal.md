...
| connection_goal |
| [Prev](hooks.core.config_option_pre_set.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.connection_post_bind.php) |
...
`int <var class="pdparam">binding_slot</var>`;
`Skiplist * <var class="pdparam">aq</var>`;
`int * <var class="pdparam">goal</var>`;<a name="idp442592"></a>
## Description
...
| [Prev](hooks.core.config_option_pre_set.php)  | [Up](hooks.core.php) |  [Next](hooks.core.connection_post_bind.php) |
