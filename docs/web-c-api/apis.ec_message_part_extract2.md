...
| ec_message_part_extract2 |
| [Prev](apis.ec_message_part_extract.php)  | Chapter 34. Message Functions |  [Next](apis.ec_message_part_get_content_type.php) |

<a name="apis.ec_message_part_extract2"></a>
## Name
...
| `io_object * **ec_message_part_extract2** (` | <var class="pdparam">part</var>, |   |
...
`const char * <var class="pdparam">desired_charset</var>`;<a name="idp28828400"></a>
## Description
...
| [Prev](apis.ec_message_part_extract.php)  | [Up](ec_message.php) |  [Next](apis.ec_message_part_get_content_type.php) |
| ec_message_part_extract  | [Table of Contents](index.php) |  ec_message_part_get_content_type |
