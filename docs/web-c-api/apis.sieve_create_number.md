...
| sieve_create_number |
| [Prev](apis.sieve_create_hash.php)  | Chapter 44. Sieve Functions |  [Next](apis.sieve_create_string.php) |
...
`u_int32_t <var class="pdparam">number</var>`;<a name="idp32374944"></a>
## Description
...
| [Prev](apis.sieve_create_hash.php)  | [Up](sieve.php) |  [Next](apis.sieve_create_string.php) |
| sieve_create_hash  | [Table of Contents](index.php) |  sieve_create_string |
