...
| [Prev](hooks.core.outbound_tls_verify.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.post_config_commit.php) |
...
`email_message * <var class="pdparam">orig</var>`;
`email_message * <var class="pdparam">forwarded</var>`;<a name="idp13671728"></a>
## Description
...
| [Prev](hooks.core.outbound_tls_verify.php)  | [Up](hooks.core.php) |  [Next](hooks.core.post_config_commit.php) |
| outbound_tls_verify  | [Table of Contents](index.php) |  post_config_commit |
