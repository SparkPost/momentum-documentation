...
| [Prev](apis.ec_message_render_headers_to_string.php)  | Chapter 34. Message Functions |  [Next](apis.ec_message_render_part_headers_to_string.php) |
...
`int <var class="pdparam">flags</var>`;<a name="idp29125376"></a>
## Description
...
| [Prev](apis.ec_message_render_headers_to_string.php)  | [Up](ec_message.php) |  [Next](apis.ec_message_render_part_headers_to_string.php) |
