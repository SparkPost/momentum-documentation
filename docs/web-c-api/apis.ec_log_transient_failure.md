...
| ec_log_transient_failure |
| [Prev](apis.ec_log_rejection2.php)  | Chapter 31. Logging Functions |  [Next](mailq.php) |
...
`const string * <var class="pdparam">notestr</var>`;<a name="idp26811328"></a>
## Description
...
| [Prev](apis.ec_log_rejection2.php)  | [Up](logging.php) |  [Next](mailq.php) |
| ec_log_rejection2  | [Table of Contents](index.php) |  Chapter 32. Mail Queue Functions |
