...
| ec_message_snapshot |
| [Prev](apis.ec_message_should_reduce_resources.php)  | Chapter 34. Message Functions |  [Next](apis.ec_message_swap_in.php) |
...
`ec_message * <var class="pdparam">orig</var>`;<a name="idp29706336"></a>
## Description
...
| [Prev](apis.ec_message_should_reduce_resources.php)  | [Up](ec_message.php) |  [Next](apis.ec_message_swap_in.php) |
| ec_message_should_reduce_resources  | [Table of Contents](index.php) |  ec_message_swap_in |
