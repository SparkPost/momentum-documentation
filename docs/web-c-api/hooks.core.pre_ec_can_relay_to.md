...
| pre_ec_can_relay_to |
| [Prev](hooks.core.pre_drop_privileges.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.pre_esmtp_auth.php) |
...
`const char * <var class="pdparam">domain</var>`;
`int * <var class="pdparam">rv</var>`;
`int * <var class="pdparam">cont</var>`;<a name="idp17983008"></a>
## Description
...
| [Prev](hooks.core.pre_drop_privileges.php)  | [Up](hooks.core.php) |  [Next](hooks.core.pre_esmtp_auth.php) |
| pre_drop_privileges  | [Table of Contents](index.php) |  pre_esmtp_auth |
