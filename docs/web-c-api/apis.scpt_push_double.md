...
| scpt_push_double |
| [Prev](apis.scpt_parse_params.php)  | Chapter 42. Scriptlet (and Alerting) Functions |  [Next](apis.scpt_push_integer.php) |
...
`double <var class="pdparam">value</var>`;<a name="idp31736416"></a>
## Description
...
<a name="idp31745264"></a>
## See Also

[Chapter 42, *Scriptlet (and Alerting) Functions*](script.php "Chapter 42. Scriptlet (and Alerting) Functions") 

| [Prev](apis.scpt_parse_params.php)  | [Up](script.php) |  [Next](apis.scpt_push_integer.php) |
| scpt_parse_params  | [Table of Contents](index.php) |  scpt_push_integer |
