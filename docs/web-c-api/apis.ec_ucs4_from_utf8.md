...
| ec_ucs4_from_utf8 |
| [Prev](apis.ec_parse_url.php)  | Chapter 55. Utility Functions |  [Next](apis.ec_util_power_2.php) |
...
`unsigned char * <var class="pdparam">lim</var>`;<a name="idp36523216"></a>
## Description
...
| [Prev](apis.ec_parse_url.php)  | [Up](utility.php) |  [Next](apis.ec_util_power_2.php) |
| ec_parse_url  | [Table of Contents](index.php) |  ec_util_power_2 |
