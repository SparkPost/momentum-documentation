...
| [Prev](hooks.core.cache_set.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.check_outbound_mess_throttle.php) |
...
`domain_record * <var class="pdparam">dr</var>`;
`struct timeval * <var class="pdparam">now</var>`;
`struct timeval * <var class="pdparam">later</var>`;<a name="idp5720464"></a>
## Description

Called when a throttle is checked. Returning non-zero causes the session to be suspended until at least 'later'

| [Prev](hooks.core.cache_set.php)  | [Up](hooks.core.php) |  [Next](hooks.core.check_outbound_mess_throttle.php) |
