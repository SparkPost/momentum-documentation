...
| [Prev](apis.ec_message_change_binding_slot.php)  | Chapter 34. Message Functions |  [Next](apis.ec_message_context_delete.php) |
...
`int <var class="pdparam">w</var>`;<a name="idp27835488"></a>
## Description
...
| [Prev](apis.ec_message_change_binding_slot.php)  | [Up](ec_message.php) |  [Next](apis.ec_message_context_delete.php) |
