...
| [Prev](hooks.core.config_option_post_set.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.connection_goal.php) |
...
`ec_config_header * <var class="pdparam">cfghdr</var>`;
`ec_config_option * <var class="pdparam">opt</var>`;
`void ** <var class="pdparam">container</var>`;<a name="idp417728"></a>
## Description
...
| [Prev](hooks.core.config_option_post_set.php)  | [Up](hooks.core.php) |  [Next](hooks.core.connection_goal.php) |
