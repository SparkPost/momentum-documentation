...
| round |
| [Prev](apis.protocol_string_uc.php)  | Chapter 55. Utility Functions |  [Next](apis.rs_getlist.php) |
...
`double <var class="pdparam">x</var>`;<a name="idp36776768"></a>
## Description
...
| [Prev](apis.protocol_string_uc.php)  | [Up](utility.php) |  [Next](apis.rs_getlist.php) |
| protocol_string_uc  | [Table of Contents](index.php) |  rs_getlist |
