...
| [Prev](hooks.core.post_event_write.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.post_generate_soft_bounce_message.php) |
...
`ec_message * <var class="pdparam">orig</var>`;
`ec_message * <var class="pdparam">bounce</var>`;
`dsn_actype <var class="pdparam">action</var>`;<a name="idp18249328"></a>
## Description
...
| [Prev](hooks.core.post_event_write.php)  | [Up](hooks.core.php) |  [Next](hooks.core.post_generate_soft_bounce_message.php) |
