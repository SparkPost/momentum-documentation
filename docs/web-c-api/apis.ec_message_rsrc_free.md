...
| ec_message_rsrc_free |
| [Prev](apis.ec_message_rsrc_flush.php)  | Chapter 34. Message Functions |  [Next](apis.ec_message_rsrc_get.php) |
...
`ec_message_resource_t * <var class="pdparam">resource</var>`;<a name="idp29363488"></a>
## Description
...
| [Prev](apis.ec_message_rsrc_flush.php)  | [Up](ec_message.php) |  [Next](apis.ec_message_rsrc_get.php) |
| ec_message_rsrc_flush  | [Table of Contents](index.php) |  ec_message_rsrc_get |
