...
| validate_context_set_code |
| [Prev](apis.validate_context_set.php)  | Chapter 56. Validation Context Functions |  [Next](xmpp.php) |
...
`const char * <var class="pdparam">str</var>`;<a name="idp37132576"></a>
## Description
...
| [Prev](apis.validate_context_set.php)  | [Up](validate.php) |  [Next](xmpp.php) |
| validate_context_set  | [Table of Contents](index.php) |  Chapter 57. XMPP Functions |
