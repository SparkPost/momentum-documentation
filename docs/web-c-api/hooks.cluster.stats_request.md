...
| stats_request |
| [Prev](hooks.cluster.nodename.php)  | Chapter 59. Hooks in the cluster Scope |  [Next](hooks.cluster.subcluster.php) |
...
`int <var class="pdparam">which</var>`;
`char * <var class="pdparam">mess</var>`;
`int <var class="pdparam">len</var>`;<a name="idp11811520"></a>
## Description
...
| [Prev](hooks.cluster.nodename.php)  | [Up](hooks.cluster.php) |  [Next](hooks.cluster.subcluster.php) |
| nodename  | [Table of Contents](index.php) |  subcluster |
