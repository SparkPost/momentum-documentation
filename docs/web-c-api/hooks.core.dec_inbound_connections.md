...
| [Prev](hooks.core.control_shutdown_ex.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.dec_outbound_connections.php) |
...
`char * <var class="pdparam">conntype</var>`;
`int <var class="pdparam">fd</var>`;
`accept_construct * <var class="pdparam">ac</var>`;<a name="idp19129360"></a>
## Description
...
| [Prev](hooks.core.control_shutdown_ex.php)  | [Up](hooks.core.php) |  [Next](hooks.core.dec_outbound_connections.php) |
