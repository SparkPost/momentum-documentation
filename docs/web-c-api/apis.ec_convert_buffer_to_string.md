...
| [Prev](apis.ec_convert_buffer.php)  | Chapter 6. Base64 Encode/Decode and Related Functions |  [Next](apis.ec_convert_io.php) |
...
`string * <var class="pdparam">deststring</var>`;<a name="idp20106400"></a>
## Description
...
| [Prev](apis.ec_convert_buffer.php)  | [Up](base64.php) |  [Next](apis.ec_convert_io.php) |
| ec_convert_buffer  | [Table of Contents](index.php) |  ec_convert_io |
