...
| [Prev](apis.ec_message_context_exists_and_get.php)  | Chapter 34. Message Functions |  [Next](apis.ec_message_context_get.php) |
...
`int <var class="pdparam">w</var>`;<a name="idp27965856"></a>
## Description
...
| [Prev](apis.ec_message_context_exists_and_get.php)  | [Up](ec_message.php) |  [Next](apis.ec_message_context_get.php) |
