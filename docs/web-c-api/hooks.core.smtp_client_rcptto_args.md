...
| [Prev](hooks.core.smtp_client_mailfrom_args.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.smtp_client_xclient_args.php) |
...
`delivery_construct * <var class="pdparam">dc</var>`;
`smtp_client_args * <var class="pdparam">args</var>`;<a name="idp18818656"></a>
## Description
...
| [Prev](hooks.core.smtp_client_mailfrom_args.php)  | [Up](hooks.core.php) |  [Next](hooks.core.smtp_client_xclient_args.php) |
