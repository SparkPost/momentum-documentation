...
| [Prev](hooks.core.get_outbound_tls_parameters.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.get_received_header_text.php) |
...
`accept_construct * <var class="pdparam">ac</var>`;
`validate_context * <var class="pdparam">ctx</var>`;
`email_message * <var class="pdparam">mess</var>`;<a name="idp13178048"></a>
## Description
...
| [Prev](hooks.core.get_outbound_tls_parameters.php)  | [Up](hooks.core.php) |  [Next](hooks.core.get_received_header_text.php) |
