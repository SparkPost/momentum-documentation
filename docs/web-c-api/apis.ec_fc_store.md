...
| ec_fc_store |
| [Prev](apis.ec_fc_stat.php)  | Chapter 25. Fast Cache Functions |  [Next](apis.ec_fc_store_expire.php) |
...
`size_t <var class="pdparam">key_length</var>`;<a name="idp24863904"></a>
## Description
...
| [Prev](apis.ec_fc_stat.php)  | [Up](fastcache.php) |  [Next](apis.ec_fc_store_expire.php) |
| ec_fc_stat  | [Table of Contents](index.php) |  ec_fc_store_expire |
