...
| scpt_ffi_cif_alloc |
| [Prev](apis.scpt_execute_or_resume.php)  | Chapter 42. Scriptlet (and Alerting) Functions |  [Next](apis.scpt_ffi_closure_alloc.php) |
...
`void ** <var class="pdparam">args</var>`;<a name="idp31597024"></a>
## Description
...
<a name="idp31603344"></a>
## See Also

[Chapter 42, *Scriptlet (and Alerting) Functions*](script.php "Chapter 42. Scriptlet (and Alerting) Functions") 

| [Prev](apis.scpt_execute_or_resume.php)  | [Up](script.php) |  [Next](apis.scpt_ffi_closure_alloc.php) |
| scpt_execute_or_resume  | [Table of Contents](index.php) |  scpt_ffi_closure_alloc |
