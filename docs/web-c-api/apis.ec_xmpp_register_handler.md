...
| ec_xmpp_register_handler |
| [Prev](apis.ec_xmpp_jid_parse.php)  | Chapter 57. XMPP Functions |  [Next](apis.ec_xmpp_route_stanza.php) |
...
`ec_xmpp_handler * <var class="pdparam">handler</var>`;<a name="idp37164320"></a>
## Description
...
| [Prev](apis.ec_xmpp_jid_parse.php)  | [Up](xmpp.php) |  [Next](apis.ec_xmpp_route_stanza.php) |
| ec_xmpp_jid_parse  | [Table of Contents](index.php) |  ec_xmpp_route_stanza |
