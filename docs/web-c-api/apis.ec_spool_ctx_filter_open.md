...
| [Prev](apis.ec_spool_ctx_enum_messages.php)  | Chapter 49. Spool-related Functions |  [Next](apis.ec_spool_ctx_get_spool_base.php) |
...
`int <var class="pdparam">mode</var>`;<a name="idp34842448"></a>
## Description
...
<a name="idp34860016"></a>
## See Also

[Section 68.42, “ec_spool_ctx”](structs.ec_spool_ctx.php "68.42. ec_spool_ctx"), [Section 68.38, “ec_message”](structs.ec_message.php "68.38. ec_message") and [Section 68.55, “io_object”](structs.io_object.php "68.55. io_object")

| [Prev](apis.ec_spool_ctx_enum_messages.php)  | [Up](spool.php) |  [Next](apis.ec_spool_ctx_get_spool_base.php) |
| ec_spool_ctx_enum_messages  | [Table of Contents](index.php) |  ec_spool_ctx_get_spool_base |
