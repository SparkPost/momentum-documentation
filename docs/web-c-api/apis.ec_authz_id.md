...
| ec_authz_id |
| [Prev](apis.ec_authz_enum_groups.php)  | Chapter 43. Security |  [Next](apis.ec_register_authz_handler2.php) |
...
`Event * <var class="pdparam">session</var>`;<a name="idp32153712"></a>
## Description
...
<a name="idp32158800"></a>
## See Also

[authz id](https://support.messagesystems.com/docs/web-ref/console_commands.authz_id.php)

| [Prev](apis.ec_authz_enum_groups.php)  | [Up](security.php) |  [Next](apis.ec_register_authz_handler2.php) |
| ec_authz_enum_groups  | [Table of Contents](index.php) |  ec_register_authz_handler2 |
