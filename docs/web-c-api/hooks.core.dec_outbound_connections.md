...
| [Prev](hooks.core.dec_inbound_connections.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.disk_queue_core_inject.php) |
...
`connection_handle * <var class="pdparam">connh</var>`;<a name="idp10804384"></a>
## Description
...
| [Prev](hooks.core.dec_inbound_connections.php)  | [Up](hooks.core.php) |  [Next](hooks.core.disk_queue_core_inject.php) |
