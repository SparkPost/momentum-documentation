...
| ec_message_swap_in |
| [Prev](apis.ec_message_snapshot.php)  | Chapter 34. Message Functions |  [Next](apis.ec_message_swap_out.php) |
...
`int <var class="pdparam">flags</var>`;<a name="idp29719568"></a>
## Description
...
| [Prev](apis.ec_message_snapshot.php)  | [Up](ec_message.php) |  [Next](apis.ec_message_swap_out.php) |
