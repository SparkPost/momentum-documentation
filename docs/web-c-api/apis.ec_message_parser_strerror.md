...
| [Prev](apis.ec_message_parser_defaults2.php)  | Chapter 34. Message Functions |  [Next](apis.ec_message_part_add_child_first.php) |
...
`int <var class="pdparam">err</var>`;<a name="idp28648288"></a>
## Description
...
| [Prev](apis.ec_message_parser_defaults2.php)  | [Up](ec_message.php) |  [Next](apis.ec_message_part_add_child_first.php) |
| ec_message_parser_defaults2  | [Table of Contents](index.php) |  ec_message_part_add_child_first |
