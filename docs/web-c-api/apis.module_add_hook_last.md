...
| module_add_hook_last |
| [Prev](apis.module_add_hook_first.php)  | Chapter 37. Module-related Functions |  [Next](apis.module_get_hook_array_from_transaction.php) |
...
`int <var class="pdparam">flags</var>`;<a name="idp30556928"></a>
## Description
...
| [Prev](apis.module_add_hook_first.php)  | [Up](module.php) |  [Next](apis.module_get_hook_array_from_transaction.php) |
| module_add_hook_first  | [Table of Contents](index.php) |  module_get_hook_array_from_transaction |
