...
| [Prev](apis.smpp_wrap_in_string.php)  | Chapter 46. SMPP Functions |  [Next](apis.smpp_write_msg_text_blob.php) |
...
`int <var class="pdparam">len</var>`;<a name="idp34106160"></a>
## Description
...
The output string. For a description of this data type see [Section 68.85, “string”](structs.string.php "68.85. string").

**Threading**

It is legal to call this function in any thread.

<a name="idp34117568"></a>
## See Also
...
| [Prev](apis.smpp_wrap_in_string.php)  | [Up](smpp.php) |  [Next](apis.smpp_write_msg_text_blob.php) |
| smpp_wrap_in_string  | [Table of Contents](index.php) |  smpp_write_msg_text_blob |
