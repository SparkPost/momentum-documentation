...
| log_error |
| [Prev](hooks.core.log_delivery_v1.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.log_permanent_failure_v1.php) |
...
`int <var class="pdparam">level</var>`;
`const char * <var class="pdparam">format</var>`;
`va_list <var class="pdparam">arg</var>`;<a name="idp14413744"></a>
## Description

This registerable hook mirrors the module callback of the same name.

| [Prev](hooks.core.log_delivery_v1.php)  | [Up](hooks.core.php) |  [Next](hooks.core.log_permanent_failure_v1.php) |
| log_delivery_v1  | [Table of Contents](index.php) |  log_permanent_failure_v1 |
