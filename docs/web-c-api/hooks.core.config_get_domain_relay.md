...
| [Prev](hooks.core.check_outbound_mess_throttle.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.config_fetch_domain_routes.php) |
...
`generic_module_infrastructure * <var class="pdparam">cs</var>`;
`const char * <var class="pdparam">domain</var>`;
`int * <var class="pdparam">retval</var>`;<a name="idp19067776"></a>
## Description
...
| [Prev](hooks.core.check_outbound_mess_throttle.php)  | [Up](hooks.core.php) |  [Next](hooks.core.config_fetch_domain_routes.php) |
| check_outbound_mess_throttle  | [Table of Contents](index.php) |  config_fetch_domain_routes |
