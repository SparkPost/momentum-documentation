...
| [Prev](hooks.core.check_outbound_conn_throttle.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.config_get_domain_relay.php) |
...
`domain_record * <var class="pdparam">dr</var>`;
`struct timeval * <var class="pdparam">now</var>`;
`struct timeval * <var class="pdparam">later</var>`;<a name="idp19044480"></a>
## Description

Called when a throttle is checked. Returning non-zero causes the session to be suspended until at least 'later'

| [Prev](hooks.core.check_outbound_conn_throttle.php)  | [Up](hooks.core.php) |  [Next](hooks.core.config_get_domain_relay.php) |
