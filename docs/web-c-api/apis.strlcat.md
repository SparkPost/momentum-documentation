...
| strlcat |
| [Prev](apis.stringwrite_strings.php)  | Chapter 51. String Functions |  [Next](apis.strlcpy.php) |
...
`size_t <var class="pdparam">size</var>`;<a name="idp35680576"></a>
## Description
...
| [Prev](apis.stringwrite_strings.php)  | [Up](string.php) |  [Next](apis.strlcpy.php) |
| stringwrite_strings  | [Table of Contents](index.php) |  strlcpy |
