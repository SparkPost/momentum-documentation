...
| scpt_push_ref |
| [Prev](apis.scpt_push_object_by_typename.php)  | Chapter 42. Scriptlet (and Alerting) Functions |  [Next](apis.scpt_push_string.php) |
...
`int <var class="pdparam">ref</var>`;<a name="idp31912128"></a>
## Description
...
<a name="idp31920960"></a>
## See Also

[Chapter 42, *Scriptlet (and Alerting) Functions*](script.php "Chapter 42. Scriptlet (and Alerting) Functions") 

| [Prev](apis.scpt_push_object_by_typename.php)  | [Up](script.php) |  [Next](apis.scpt_push_string.php) |
| scpt_push_object_by_typename  | [Table of Contents](index.php) |  scpt_push_string |
