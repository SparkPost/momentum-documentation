...
| multicast_subscribe |
| [Prev](hooks.msgc.multicast_publish.php)  | Chapter 64. Hooks in the msgc Scope |  [Next](hooks.publish.php) |
...
`int <var class="pdparam">group_len</var>`;
`const unsigned char * <var class="pdparam">data</var>`;
`int <var class="pdparam">data_len</var>`;<a name="idp11745760"></a>
## Description

Called when any multicast message is received by MSGC

| [Prev](hooks.msgc.multicast_publish.php)  | [Up](hooks.msgc.php) |  [Next](hooks.publish.php) |
| multicast_publish  | [Table of Contents](index.php) |  Chapter 65. Hooks in the publish Scope |
