...
| [Prev](hooks.core.ec_ssl_SSL_CTX_fixup.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.final_validation.php) |
...
`message_construct * <var class="pdparam">mc</var>`;<a name="idp19015568"></a>
## Description
...
| [Prev](hooks.core.ec_ssl_SSL_CTX_fixup.php)  | [Up](hooks.core.php) |  [Next](hooks.core.final_validation.php) |
