...
| A.5. Compiling in C |
| [Prev](custom_channels.custom.routines.php)  | Appendix A. Custom Delivery Modules |   |
...
| [Prev](custom_channels.custom.routines.php)  | [Up](custom_channels.php) |   |
| A.4. Custom Callback Functions  | [Table of Contents](index.php) |   |
