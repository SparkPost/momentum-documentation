...
| cidr_ipv6_count2 |
| [Prev](apis.cidr_ipv4_delete.php)  | Chapter 10. CIDR Functions |  [Next](apis.cidr_query.php) |
...
`const char * <var class="pdparam">cidr</var>`;<a name="idp20750480"></a>
## Description
...
| [Prev](apis.cidr_ipv4_delete.php)  | [Up](cidr.php) |  [Next](apis.cidr_query.php) |
| cidr_ipv4_delete  | [Table of Contents](index.php) |  cidr_query |
