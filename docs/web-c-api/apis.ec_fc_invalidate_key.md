...
| [Prev](apis.ec_fc_invalidate.php)  | Chapter 25. Fast Cache Functions |  [Next](apis.ec_fc_load.php) |
...
`size_t <var class="pdparam">key_length</var>`;<a name="idp24720496"></a>
## Description
...
| [Prev](apis.ec_fc_invalidate.php)  | [Up](fastcache.php) |  [Next](apis.ec_fc_load.php) |
| ec_fc_invalidate  | [Table of Contents](index.php) |  ec_fc_load |
