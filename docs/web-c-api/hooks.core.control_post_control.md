...
| [Prev](hooks.core.control_post_command.php)  | Chapter 60. Hooks in the core scope |  [Next](hooks.core.control_pre_command.php) |
...
`const char * <var class="pdparam">argv[]</var>`;
`ec_control_context * <var class="pdparam">input</var>`;
`ec_control_context * <var class="pdparam">output</var>`;<a name="idp772592"></a>
## Description
...
| [Prev](hooks.core.control_post_command.php)  | [Up](hooks.core.php) |  [Next](hooks.core.control_pre_command.php) |
