...
| [Prev](conf.ref.max_recipients_per_connection.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.max_resident_messages.php) |
...
| [Prev](conf.ref.max_recipients_per_connection.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.max_resident_messages.php) |
| max_recipients_per_connection  | [Table of Contents](index.php) |  max_resident_messages |
