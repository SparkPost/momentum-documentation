...
When this option is used in scopes other than the Host scope, The cluster module must have the outbound_domains parameter configured as defined here: [Section 7.7.1, “Replication Configurations”](cluster.config.replication.php#cluster.replication.features "7.7.1. Replication Configurations").
...
[max_outbound_connections](conf.ref.max_outbound_connections.php "max_outbound_connections") [host](conf.ref.host.php "host") [Section 2.6, “Configuration Scopes and Fallback”](ecelerity.conf.fallback.php "2.6. Configuration Scopes and Fallback")
