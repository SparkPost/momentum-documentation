...
| vctx:recipient_list |
| [Prev](lua.ref.vctx_get.php)  | 15.2. Lua Functions |  [Next](lua.ref.vctx_remove_recipient.php) |
...
[Example 15.71, “vctx_add_recipient example”](lua.ref.vctx_add_recipient.php#lua.ref.vctx_add_recipient.example "Example 15.71. vctx_add_recipient example")
