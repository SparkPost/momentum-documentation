...
| ec_adtool |
| [Prev](executable.ec_admigrate.php)  | 11.2. Executable Commands |  [Next](executable.ec_cmd.php) |
...
You only need use this tool when the adaptive module is loaded. For more information see [Section 14.2, “adaptive – Adaptive Delivery”](modules.adaptive.php "14.2. adaptive – Adaptive Delivery").
...
[Section 14.2, “adaptive – Adaptive Delivery”](modules.adaptive.php "14.2. adaptive – Adaptive Delivery"), [ec_admigrate](executable.ec_admigrate.php "ec_admigrate"), [Section 4.4, “Riak”](operations.riak.php "4.4. Riak")

| [Prev](executable.ec_admigrate.php)  | [Up](exe.commands.details.php) |  [Next](executable.ec_cmd.php) |
| ec_admigrate  | [Table of Contents](index.php) |  ec_cmd |
