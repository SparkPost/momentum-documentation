...
| [json.decode](lua.ref.json.decode.php "json.decode") – Create a JSON object from a JSON string | str | json | 3.1 | any |
| [json.encode](lua.ref.json.encode.php "json.encode") – Convert a Lua variable or expression so that it can be added to a JSON object | obj | json | 3.1 | any |
| [json.new](lua.ref.json.new.php "json.new") – Create an empty JSON object |   | json | 3.1 | any |
| [json.strerror](lua.ref.json.strerror.php "json.strerror") – Return the description of a JSON error code | code | json | 3.1 | any |
| [msg.batch_id](lua.ref.msg.batch_id.php "msg.batch_id") – Returns the human-readable ec_message.batch_id |   | msys.extended.message | 3.1 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg.conn_id](lua.ref.msg.conn_id.php "msg.conn_id") – Returns the human-readable ec_message.conn_id |   | msys.extended.message | 3.1 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg.id](lua.ref.msg.id.php "msg.id") – Returns the human-readable ec_message.id |   | msys.extended.message | 3.1 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg:binding](lua.ref.msg_binding.php "msg:binding") – Sets the binding to the named binding, if one is provided | [value] | msys.extended.message | 3.0 | set_binding |
| [msg:binding_group](lua.ref.msg_binding_group.php "msg:binding_group") – Sets the binding_group to the named binding, if one is provided | [value] | msys.extended.message | 3.0 | set_binding |
| [msg:body](lua.ref.msg_body.php "msg:body") – Set or get the message body (minus headers) | [...] | msys.extended.message | 3.1 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg:body_match](lua.ref.msg_body_match.php "msg:body_match") – Streaming interface to a PCRE search of a message body (minus headers) | pattern | msys.extended.message | 3.0 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg:body_replace](lua.ref.msg_body_replace.php "msg:body_replace") – Streaming interface to a PCRE replacement of a message body (minus headers) | pattern, replacement | msys.extended.message | 3.0 | data, data_spool, data_spool_each_rcpt |
| [msg:build](lua.ref.msg_build.php "msg:build") – Create a message | headers, parts, attachments | msys.extended.message | 3.1 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg:code](lua.ref.msg_code.php "msg:code") – Get or set the message code | [number], [string] | msys.extended.message | 3.0 | data, data_spool, data_spool_each_rcpt |
| [msg:context_delete](lua.ref.msg_context_delete.php "msg:context_delete") – Delete a context variable | type, key | msys.core | 3.0 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg:context_exists](lua.ref.msg_context_exists.php "msg:context_exists") – Check if a context variable exists | type, key | msys.core | 3.0 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg:context_exists_and_get](lua.ref.msg_context_exists_and_get.php "msg:context_exists_and_get") – Check if a context variable exists and get it | type, key | msys.core | 3.0 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg:context_get](lua.ref.msg_context_get.php "msg:context_get") – Get a context variable | type, key | msys.core | 3.0 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg:context_set](lua.ref.msg_context_set.php "msg:context_set") – Set a context variable | type, key, value | msys.core | 3.0 | data, data_spool, data_spool_each_rcpt, set_binding |
| [msg:discard](lua.ref.msg_discard.php "msg:discard") – Silently discard a message | [reason] | msys.extended.message | 3.0 | data, data_spool, data_spool_each_rcpt |
...
| [msg:get_delivery_method](lua.ref.msg_get_delivery_method.php "msg:get_delivery_method") – Return the delivery method for a message |   | msys.core | 3.1 | data, data_spool, data_spool_each_rcpt |
| [msg:get_envelope2](lua.ref.msg_get_envelope2.php "msg:get_envelope2") – Get envelope values | flags, localpart_str, domain_str | msys.extended.message | 3.0.9 | data, data_spool, data_spool_each_rcpt, set_binding |
...
| [msys.gauge_cache.inc](lua.ref.msys.gauge_cache.inc.php "msys.gauge_cache.inc") – Increments the value associated with keystring in the named cache | cachename, keystring | msys.gauge_cache | 3.1 | any |
...
| [msys.threadpool.stat](lua.ref.msys.threadpool.stat.php "msys.threadpool.stat") – Return stats regarding a threadpool | [threadpoolname], [jobclassID] | msys.threadpool | 3.2 | any |
...
| [msys.validate.opendkim.get_sig_identity](lua.ref.msys.validate.opendkim.get_sig_identity.php "msys.validate.opendkim.get_sig_identity") – Fetch the identity associated with a DKIM signature | dkim, dkim_sig | msys.validate.opendkim | 3.6 | data, data_spool, data_spool_each_rcpt |
...
| [Prev](lua.php)  | [Up](lua.php) |  [Next](lua.function.details.php) |
| Chapter 15. Lua Function Reference  | [Table of Contents](index.php) |  15.2. Lua Functions |
