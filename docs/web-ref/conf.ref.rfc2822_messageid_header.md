...
| [Prev](conf.ref.rfc2822_max_line_length_policy.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.rfc2822_missing_headers.php) |
...
| [Prev](conf.ref.rfc2822_max_line_length_policy.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.rfc2822_missing_headers.php) |
