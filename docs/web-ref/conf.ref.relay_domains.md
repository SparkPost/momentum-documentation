...
Any addresses set in the `addresses` option of the [Section 14.34, “fbl – Feedback Loop Module”](modules.fbl.php "14.34. fbl – Feedback Loop Module") must be set in the `relay_domains` option.
