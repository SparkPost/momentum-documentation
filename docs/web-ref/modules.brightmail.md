...
| [Prev](modules.bounce_logger.php)  | Chapter 14. Modules Reference |  [Next](modules.chunk_logger.php) |
...
If you intend to use this module be sure to choose it during installation. For more information see [Section 1.9, “Installing Additional Packages”](install.additional.packages.php "1.9. Installing Additional Packages"). You will also need to purchase a license from Symantac.
...
In version 3.x, this option must be set to `on` if you wish to use the Lua function, [msys.brightmail.scan](lua.ref.msys.brightmail.scan.php "msys.brightmail.scan").
...
| [Prev](modules.bounce_logger.php)  | [Up](modules.php) |  [Next](modules.chunk_logger.php) |
| 14.13. bounce_logger – Momentum-Style Bounce Logging  | [Table of Contents](index.php) |  14.15. chunk_logger – Asynchronous Logging |
