...
Momentum trap definitions are contained in the MIB file `OMNITI-SNMP-MIB.txt` found in the `/opt/msys/ecelerity/docs/` directory. For your convenience this file is reproduced in [Appendix B, *MIB Files*](snmp-mib.php "Appendix B. MIB Files") .
