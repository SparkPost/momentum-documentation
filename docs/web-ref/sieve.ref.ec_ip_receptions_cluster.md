...
| [Prev](sieve.ref.ec_ip_receptions.php)  | 16.2. Sieve Function Details |  [Next](sieve.ref.ec_ip_rejections.php) |
...
This feature also requires the inbound_audit module. See [Section 14.41, “inbound_audit – Inbound traffic analytics”](modules.inbound_audit.php "14.41. inbound_audit – Inbound traffic analytics") for more information.
...
| [Prev](sieve.ref.ec_ip_receptions.php)  | [Up](sieve.ref.files.php) |  [Next](sieve.ref.ec_ip_rejections.php) |
