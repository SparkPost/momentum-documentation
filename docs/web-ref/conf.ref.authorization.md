...
| authorization |
| [Prev](conf.ref.async_bounce_rendering.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.bind_address.php) |
...
[msys.registerAuth](lua.ref.msys.registerAuth.php "msys.registerAuth"), [Section 14.7, “auth_ds – Datasource based SMTP Authentication”](modules.auth_ds.php "14.7. auth_ds – Datasource based SMTP Authentication") and [Section 2.2.3, “Control Listener Authorization”](conf.aaa.php#conf.control_authz "2.2.3. Control Listener Authorization")

| [Prev](conf.ref.async_bounce_rendering.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.bind_address.php) |
