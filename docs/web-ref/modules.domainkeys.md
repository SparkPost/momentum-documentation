...
| [Prev](modules.dnsbuf.php)  | Chapter 14. Modules Reference |  [Next](modules.ds_core.php) |
...
*   [msys.validate.dk.get_responsible_domain](lua.ref.msys.validate.dk.get_responsible_domain.php "msys.validate.dk.get_responsible_domain") – Return the domain responsible for the current message

*   [msys.validate.dk.sign](lua.ref.msys.validate.dk.sign.php "msys.validate.dk.sign") – Sign a message using a Domain Key
...
[signing_stats](conf.ref.signing_stats.php "signing_stats"), [signing_stats](console_commands.signing_stats.php "signing_stats"), [signing_stats reset](console_commands.signing_stats_reset.php "signing_stats reset")

| [Prev](modules.dnsbuf.php)  | [Up](modules.php) |  [Next](modules.ds_core.php) |
| 14.28. dnsbuf – Dynamically Set the DNS UDP Buffer Size  | [Table of Contents](index.php) |  14.30. ds_core – Datasource Query Core |
