...
| dns_fallback_to_tcp |
| [Prev](conf.ref.dns_failures_to_purge.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.domain.php) |
...
| [Prev](conf.ref.dns_failures_to_purge.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.domain.php) |
| dns_failures_to_purge  | [Table of Contents](index.php) |  domain |
