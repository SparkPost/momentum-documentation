...
| [Prev](conf.ref.min_dns_ttl.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.mx_failures_to_delay.php) |
...
| [Prev](conf.ref.min_dns_ttl.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.mx_failures_to_delay.php) |
