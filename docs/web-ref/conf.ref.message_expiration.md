...
| message_expiration |
| [Prev](conf.ref.memory_hwm.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.migrate_connections_between_sibling_domains.php) |
...
| [Prev](conf.ref.memory_hwm.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.migrate_connections_between_sibling_domains.php) |
