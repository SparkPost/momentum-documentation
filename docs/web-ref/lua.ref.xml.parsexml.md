...
| xml.parsexml |
| [Prev](lua.ref.xml.node_unlink.php)  | 15.2. Lua Functions |  [Next](sieve.ref3.php) |
...
| [Prev](lua.ref.xml.node_unlink.php)  | [Up](lua.function.details.php) |  [Next](sieve.ref3.php) |
| node:unlink  | [Table of Contents](index.php) |  Chapter 16. Sieve++ Function Reference |
