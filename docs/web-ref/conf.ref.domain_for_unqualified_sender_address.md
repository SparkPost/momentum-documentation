...
| [Prev](conf.ref.domain_for_unqualified_recipient_addresses.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.domainkeys.php) |
...
| [Prev](conf.ref.domain_for_unqualified_recipient_addresses.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.domainkeys.php) |
| domain_for_unqualified_recipient_addresses  | [Table of Contents](index.php) |  domainkeys |
