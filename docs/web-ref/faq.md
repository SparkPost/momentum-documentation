...
| [Prev](p.appendices.php)  | Part III. Appendices |  [Next](snmp-mib.php) |
...
<dt>A.2\. [How can I run two or more Momentum instances concurrently?](faq.php#faq.running.multiple.instances)</dt>

<dt>A.3\. [I see error messages saying "errno=24" (on linux), "nropen too low," or "Could not set nofiles high enough!" in my mainlog.ec. What do they mean and how can I prevent this?](faq.php#faq.num.open.files)</dt>

<dt>A.4\. [When I say:](faq.php#faq.sieve.array.after.variable)</dt>
...
Consult your system documentation for further information on changing the per-process open file descriptor limit, or see [Section 1.5, “Operating System Specific Preparation”](install.os-specific.php "1.5. Operating System Specific Preparation") for recommended settings specific to your operating system.
...
| [Prev](p.appendices.php)  | [Up](p.appendices.php) |  [Next](snmp-mib.php) |
| Part III. Appendices  | [Table of Contents](index.php) |  Appendix B. MIB Files |
