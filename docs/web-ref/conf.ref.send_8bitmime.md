...
| send_8bitmime |
| [Prev](conf.ref.security.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.server_max_file_descriptors.php) |
...
| [Prev](conf.ref.security.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.server_max_file_descriptors.php) |
