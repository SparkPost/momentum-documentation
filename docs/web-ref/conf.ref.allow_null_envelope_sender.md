...
| [Prev](conf.ref.allow_ip_literal.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.allow_trailing_whitespace_in_commands.php) |
...
| [Prev](conf.ref.allow_ip_literal.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.allow_trailing_whitespace_in_commands.php) |
