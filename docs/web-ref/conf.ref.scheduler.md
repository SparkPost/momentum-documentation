...
| scheduler |
| [Prev](conf.ref.rset_timeout.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.scope_max_outbound_connections.php) |
...
| [Prev](conf.ref.rset_timeout.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.scope_max_outbound_connections.php) |
| rset_timeout  | [Table of Contents](index.php) |  scope_max_outbound_connections |
