...
| [Prev](conf.ref.max_retry_interval.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.mdn_failures_notify.php) |
...
| [Prev](conf.ref.max_retry_interval.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.mdn_failures_notify.php) |
