...
| rset_timeout |
| [Prev](conf.ref.routes.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.scheduler.php) |
...
| [Prev](conf.ref.routes.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.scheduler.php) |
| routes  | [Table of Contents](index.php) |  scheduler |
