...
| 15.2. Lua Functions |
| [Prev](lua.summary_table.php)  | Chapter 15. Lua Function Reference |  [Next](lua.ref.msys.db.execute.php) |
...
| [Prev](lua.summary_table.php)  | [Up](lua.php) |  [Next](lua.ref.msys.db.execute.php) |
| 15.1. Lua Functions List  | [Table of Contents](index.php) |  msys.db.execute |
