...
| host_failure_retry |
| [Prev](conf.ref.host.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.hostname.php) |
...
| [Prev](conf.ref.host.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.hostname.php) |
| host  | [Table of Contents](index.php) |  hostname |
