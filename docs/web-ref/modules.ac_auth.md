...
| [Prev](modules.php)  | Chapter 14. Modules Reference |  [Next](modules.adaptive.php) |
...
To implement any action, you must load the Lua script that hooks `ac_auth_perform_auth` or `ac_auth_log_auth_failure`, e.g.: [Example 14.1, “"ac_auth" in ecelerity.conf”](modules.ac_auth.php#example.ac_auth.ref "Example 14.1. "ac_auth" in ecelerity.conf").
...
| Chapter 14. Modules Reference  | [Table of Contents](index.php) |  14.2. adaptive – Adaptive Delivery |
