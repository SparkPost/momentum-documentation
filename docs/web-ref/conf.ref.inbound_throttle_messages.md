...
| [Prev](conf.ref.idle_timeout.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.initial_hash_buckets.php) |
...
| [Prev](conf.ref.idle_timeout.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.initial_hash_buckets.php) |
