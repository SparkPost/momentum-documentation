...
| ec_valid_mime |
| [Prev](sieve.ref.ec_valid_binding.php)  | 16.2. Sieve Function Details |  [Next](sieve.ref.eleven_scan.php) |
...
| [Prev](sieve.ref.ec_valid_binding.php)  | [Up](sieve.ref.files.php) |  [Next](sieve.ref.eleven_scan.php) |
| ec_valid_binding  | [Table of Contents](index.php) |  eleven_scan |
