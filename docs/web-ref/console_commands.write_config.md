...
| write config |
| [Prev](console_commands.version.php)  | 12.2. System Console Commands |  [Next](modules.overview.php) |
...
If you are in the middle of a transaction (begun with **config begin** ) **write config**        will not show any changes you have made. Use **config showrecurse**             or **config show**      instead. For more information see [the section called “config show and config showrecurse”](console_commands.config.php#console_config_show "config show and config showrecurse").

| [Prev](console_commands.version.php)  | [Up](console.commands.non-module.php) |  [Next](modules.overview.php) |
| version  | [Table of Contents](index.php) |  Chapter 13. Modules |
