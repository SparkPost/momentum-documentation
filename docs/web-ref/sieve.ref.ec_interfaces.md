...
| ec_interfaces |
| [Prev](sieve.ref.ec_include.php)  | 16.2. Sieve Function Details |  [Next](sieve.ref.ec_ip_connections.php) |
...
This feature is an extension to the Sieve system and can be made available by loading the mail_loop module. See [Section 14.45, “mail_loop – Mail Loop Detection”](modules.mail_loop.php "14.45. mail_loop – Mail Loop Detection") for more information.
...
| [Prev](sieve.ref.ec_include.php)  | [Up](sieve.ref.files.php) |  [Next](sieve.ref.ec_ip_connections.php) |
