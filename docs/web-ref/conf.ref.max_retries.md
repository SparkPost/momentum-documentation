...
| max_retries |
| [Prev](conf.ref.max_resident_transfails.php)  | 9.2. Configuration Files and Option Details |  [Next](conf.ref.max_retry_interval.php) |
...
| [Prev](conf.ref.max_resident_transfails.php)  | [Up](conf.ref.files.php) |  [Next](conf.ref.max_retry_interval.php) |
