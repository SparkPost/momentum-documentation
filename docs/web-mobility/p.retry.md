...
| Part IV. Retrying Messages |
| [Prev](mcmt2xmpp.caveat.php)  |   |  [Next](mobility.message.retry.php) |
...
| [Prev](mcmt2xmpp.caveat.php)  |   |  [Next](mobility.message.retry.php) |
| 10.6. Filtering Out Chat State Notifications  | [Table of Contents](index.php) |  Chapter 11. Retrying Messages |
