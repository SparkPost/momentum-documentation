...
<title>msys.cloudmark.add_af_data</title>
...
<link rel="prev" href="lua.ref.msys.cloudmark.analyze.php" title="msys.cloudmark.analyze">
<link rel="next" href="lua.ref.msys.cloudmark.score.php" title="msys.cloudmark.score">
...
<tr><th colspan="3" align="center">msys.cloudmark.add_af_data</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.cloudmark.analyze.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.cloudmark.score.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.cloudmark.add_af_data"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.cloudmark.add_af_data — Pass data for use with the Cloudmark ActiveFilter.</p>
</div>
<div class="refsection">
<a name="idp14992480"></a><h2>Synopsis</h2>
<pre class="literallayout">
require('msys.cloudmark')

</pre>
<p>
      <code class="function">msys.cloudmark.add_af_data(addr, data)</code>
    </p>
<pre class="literallayout">
addr: string
...
<div class="refsection">
<a name="idp14996224"></a><h2>Description</h2>
<p>
      Optionally pass the Cloudmark ActiveFilter an email address and a
      table of key-value pairs.
    </p>
<div class="note">
<h3 class="title">Note</h3>
<p>
        You must load and correctly configure the cloudmark module and
        the maildir module before using this function. This function
        does not have a return value.
      </p>
</div>
<div class="example">
<a name="lua.ref.msys.cloudmark.add_af_data.example"></a><p class="title"><b>Example 70.3. msys.cloudmark.add_af_data Example</b></p>
...
<div class="refsection">
<a name="idp15002288"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.cloudmark.score.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.cloudmark.analyze </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.cloudmark.score</td>
</tr>
</table></div>
