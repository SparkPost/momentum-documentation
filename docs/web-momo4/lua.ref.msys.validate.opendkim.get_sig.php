...
<title>msys.validate.opendkim.get_sig</title>
...
<link rel="prev" href="lua.ref.msys.validate.opendkim.get_num_sigs.php" title="msys.validate.opendkim.get_num_sigs">
<link rel="next" href="lua.ref.msys.validate.opendkim.get_sig_canons.php" title="msys.validate.opendkim.get_sig_canons">
...
<tr><th colspan="3" align="center">msys.validate.opendkim.get_sig</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.validate.opendkim.get_num_sigs.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig_canons.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.validate.opendkim.get_sig"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.validate.opendkim.get_sig — Get a signature from a DKIM object</p>
</div>
<div class="refsection">
<a name="idp18664544"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.validate.opendkim.get_sig(dkim, num)</code>
      </p>
<p>
</p>
<pre class="literallayout">
dkim: userdata, DKIM type
num: numeric, optional</pre>
<p>
      </p>
</div>
<div class="refsection">
<a name="idp18668016"></a><h2>Description</h2>
<p>
        This function gets a signature (DKIM_SIGINFO) from a DKIM
        object. It requires the
...
<li class="listitem"><p>
            ...
            <code class="function">msys.validate.opendkim.verify</code> function.
          </p></li>
<li class="listitem"><p>
            <code class="literal">num</code> – index of the DKIM_SIGINFO
            object that you wish to retrieve. The signature index, must
            be less than the number of signatures in the DKIM object.
          </p></li>
</ul></div>
<p>
        For a description of the DKIM_SIGINFO object, see
        <a class="link" href="http://www.opendkim.org/libopendkim/dkim_siginfo.html" target="_top">DKIM_SIGINFO</a>.
      </p>
<p>
        This function returns the DKIM_SIGINFO object and the DKIM
        status <code class="literal">DKIM_STAT</code>.
      </p>
<p>
...
<div class="refsection">
<a name="idp18700384"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig_canons.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.validate.opendkim.get_num_sigs </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.validate.opendkim.get_sig_canons</td>
</tr>
</table></div>
