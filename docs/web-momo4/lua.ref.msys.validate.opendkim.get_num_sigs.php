...
<title>msys.validate.opendkim.get_num_sigs</title>
...
<link rel="prev" href="lua.ref.msys.validate.dk.sign.php" title="msys.validate.dk.sign">
<link rel="next" href="lua.ref.msys.validate.opendkim.get_sig.php" title="msys.validate.opendkim.get_sig">
...
<tr><th colspan="3" align="center">msys.validate.opendkim.get_num_sigs</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.validate.dk.sign.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.validate.opendkim.get_num_sigs"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.validate.opendkim.get_num_sigs — Return the number of DKIM signatures</p>
</div>
<div class="refsection">
<a name="idp18617840"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.validate.opendkim.get_num_sigs(dkim)</code>
      </p>
<pre class="literallayout">
dkim: userdata, DKIM type</pre>
</div>
<div class="refsection">
<a name="idp18620784"></a><h2>Description</h2>
<p>
        This function returns the number of DKIM signatures. The
        <code class="literal">dkim</code> parameter is an array of DKIM_SIGINFO
        objects created by
        <code class="function">msys.validate.opendkim.verify</code>. For a
...
<p>
        This function returns the number of signatures and the DKIM
...
<div class="example">
<a name="lua.ref.msys.validate.opendkim.get_num_sigs.example"></a><p class="title"><b>Example 70.65. msys.validate.opendkim.get_num_sigs example</b></p>
...
<div class="refsection">
<a name="idp18652944"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.validate.dk.sign </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.validate.opendkim.get_sig</td>
</tr>
</table></div>
