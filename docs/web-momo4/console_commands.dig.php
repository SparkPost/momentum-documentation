...
<link rel="prev" href="console_commands.delayed.php" title="delayed">
<link rel="next" href="console_commands.dns_cache.php" title="dns_cache">
...
<a accesskey="p" href="console_commands.delayed.php">Prev</a> </td>
<th width="60%" align="center">Chapter 73. Non-Module-Specific Console Commands</th>
<td width="20%" align="right"> <a accesskey="n" href="console_commands.dns_cache.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="console_commands.dig"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>dig — submit a domain for DNS MX query</p>
</div>
<div class="refsynopsisdiv">
<h2>Synopsis</h2>
<div class="cmdsynopsis"><p><code class="command">dig</code>  [
        <em class="replaceable"><code>domain</code></em>
      ]</p></div>
</div>
<div class="refsection">
<a name="idp12047008"></a><h2>Description</h2>
<p>
...
<p>
        ...
        <a class="xref" href="console_commands.domain.php" title="domain"><span class="refentrytitle">domain</span></a> and
...
<td width="40%" align="right"> <a accesskey="n" href="console_commands.dns_cache.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">delayed </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> dns_cache</td>
</tr>
</table></div>
