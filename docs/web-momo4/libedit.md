...
| [Prev](smtp-response-codes.php)  | [Up](p.appendix.php) |  [Next](libedit.extended.php) |
| Appendix C. SMTP Response Codes  | [Table of Contents](index.php) |  D.2. Extended Commands |
