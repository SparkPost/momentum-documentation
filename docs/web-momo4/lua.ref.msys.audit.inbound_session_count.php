...
<title>msys.audit.inbound_session_count</title>
...
<link rel="prev" href="lua.ref.msys.audit.connections.php" title="msys.audit.connections">
<link rel="next" href="lua.ref.msys.audit.receptions.php" title="msys.audit.receptions">
...
<tr><th colspan="3" align="center">msys.audit.inbound_session_count</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.audit.connections.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.audit.receptions.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.audit.inbound_session_count"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.audit.inbound_session_count — Count connections currently established from the specified cidr to the
        specified service</p>
</div>
<div class="refsection">
<a name="idp17259584"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.audit.inbound_session_count(cidr,
        servicename);</code>
      </p>
...
<div class="refsection">
<a name="idp17262608"></a><h2>Description</h2>
<p>
        This function counts connections currently established from the
        specified cidr to the specified service. <code class="literal">cidr</code>
        is of the form:
      </p>
...
<li class="listitem"><p>
            <code class="literal">/32</code> evaluates exactly to the connecting
            IP
          </p></li>
<li class="listitem"><p>
...
<li class="listitem"><p>
            <code class="literal">ECStream</code>
          </p></li>
<li class="listitem"><p>
            <code class="literal">Control</code>
          </p></li>
<li class="listitem"><p>
            <code class="literal">ECmmove2</code> (the service that handles
            duravip message moves, only available when clustering is
            enabled)
          </p></li>
<li class="listitem"><p>
            <code class="literal">ECCluster</code> (only available when clustering
            is enabled)
          </p></li>
<li class="listitem"><p>
            <code class="literal">inbound_cidr</code> (only available when
...
<div class="refsection">
<a name="idp17286272"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.audit.receptions.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.audit.connections </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.audit.receptions</td>
</tr>
</table></div>
