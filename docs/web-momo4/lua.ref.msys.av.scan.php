...
<link rel="prev" href="lua.ref.msys.av.engines.php" title="msys.av.engines">
<link rel="next" href="lua.ref.msys.av.scan_part.php" title="msys.av.scan_part">
...
<tr><th colspan="3" align="center">msys.av.scan</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.av.engines.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.av.scan_part.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.av.scan"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.av.scan — Perform a virus scan using the named engine</p>
</div>
<div class="refsection">
<a name="idp17478912"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.av.scan(av_engine_name, msg,
...
<div class="refsection">
<a name="idp17482032"></a><h2>Description</h2>
<p>
...
<li class="listitem"><p>
            <code class="literal">msg</code>– optional message
            (msys.core:_ec_message)
          </p></li>
<li class="listitem"><p>
...
<p>
        If the <code class="literal">msg</code> and/or
        <code class="literal">validate_context</code> parameters are omitted, they
        will be inferred from the calling environment, if possible. If
        no message can be inferred, this function will raise an error.
      </p>
<p>
...
<div class="example">
<a name="lua.ref.msys.av.scan.example"></a><p class="title"><b>Example 70.47. msys.av.scan example using clamav</b></p>
...
<div class="refsection">
<a name="idp17516416"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.av.scan_part.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.av.engines </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.av.scan_part</td>
</tr>
</table></div>
