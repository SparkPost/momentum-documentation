...
<title>msys.audit_series.count</title>
...
<link rel="prev" href="lua.ref.msys.audit_series.add.php" title="msys.audit_series.add">
<link rel="next" href="lua.ref.msys.audit_series.define.php" title="msys.audit_series.define">
...
<tr><th colspan="3" align="center">msys.audit_series.count</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.audit_series.add.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.audit_series.define.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.audit_series.count"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.audit_series.count — Return the total associated with the named series</p>
</div>
<div class="refsection">
<a name="idp17372560"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.audit_series.count(name, options);</code>
      </p>
...
<div class="refsection">
<a name="idp17375504"></a><h2>Description</h2>
<p>
        This function returns the total associated with the named series
        that is passed in as the first argument.
      </p>
<p>
        <code class="literal">options</code> may be a table that provides
        additional query parameters. For all series types, the following
...
<li class="listitem">
<p>
            <code class="literal">key</code> interpretation depends on the series
            type
          </p>
<p>
            For a CIDR series, the key is interpreted as an IP/mask
            specifying the address of interest. If accept_construct is
            passed in, the remote IP of the accept construct is used. If
            the type is not specified or only "/mask" is specified, the
            current connected IP is assumed. For a string series, the
            key is the string key to look up. If it is not specified, an
            error is thrown.
          </p>
</li>
</ul></div>
...
<p>
        If <code class="literal">options</code> is not a table, then it is assumed
        to be the value for the key parameter.
      </p>
<p>
...
<div class="refsection">
<a name="idp17391728"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.audit_series.define.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.audit_series.add </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.audit_series.define</td>
</tr>
</table></div>
