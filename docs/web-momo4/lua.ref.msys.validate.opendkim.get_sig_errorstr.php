...
<title>msys.validate.opendkim.get_sig_errorstr</title>
...
<link rel="prev" href="lua.ref.msys.validate.opendkim.get_sig_domain.php" title="msys.validate.opendkim.get_sig_domain">
<link rel="next" href="lua.ref.msys.validate.opendkim.get_sig_flags.php" title="msys.validate.opendkim.get_sig_flags">
...
<tr><th colspan="3" align="center">msys.validate.opendkim.get_sig_errorstr</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.validate.opendkim.get_sig_domain.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig_flags.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.validate.opendkim.get_sig_errorstr"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.validate.opendkim.get_sig_errorstr — Fetch the error associated with a DKIM signature</p>
</div>
<div class="refsection">
<a name="idp18800016"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.validate.opendkim.get_sig_errorstr(dkim_sig)</code>
      </p>
<p>
</p>
...
<div class="refsection">
<a name="idp18803472"></a><h2>Description</h2>
<p>
...
<p>
        This function returns the error string associated with the DKIM
        signature (if it exists) and the DKIM status
...
<div class="refsection">
<a name="idp18832112"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig_flags.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.validate.opendkim.get_sig_domain </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.validate.opendkim.get_sig_flags</td>
</tr>
</table></div>
