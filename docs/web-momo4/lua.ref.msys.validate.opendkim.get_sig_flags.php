...
<title>msys.validate.opendkim.get_sig_flags</title>
...
<link rel="prev" href="lua.ref.msys.validate.opendkim.get_sig_errorstr.php" title="msys.validate.opendkim.get_sig_errorstr">
<link rel="next" href="lua.ref.msys.validate.opendkim.get_sig_hdrsigned.php" title="msys.validate.opendkim.get_sig_hdrsigned">
...
<tr><th colspan="3" align="center">msys.validate.opendkim.get_sig_flags</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.validate.opendkim.get_sig_errorstr.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig_hdrsigned.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.validate.opendkim.get_sig_flags"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.validate.opendkim.get_sig_flags — Fetch the flags associated with a DKIM signature</p>
</div>
<div class="refsection">
<a name="idp18843760"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.validate.opendkim.get_sig_flags(dkim_sig)</code>
      </p>
<p>
</p>
...
<div class="refsection">
<a name="idp18847216"></a><h2>Description</h2>
<p>
        This function fetches the flags associated with a DKIM
        signature. Use
        <code class="function">msys.validate.opendkim.get_num_sigs</code> and
        <code class="function">msys.validate.opendkim.get_sig</code> to get a
        DKIM_SIGINFO object to pass to this function. For a description
        of the DKIM_SIGINFO object, see
...
<p>
        This function returns a flags bitmap and the DKIM status
...
<li class="listitem"><p>
            <code class="literal">DKIM_SIGFLAG_IGNORE</code> – Signature has
            been flagged to be ignored.
          </p></li>
<li class="listitem"><p>
            <code class="literal">DKIM_SIGFLAG_PROCESSED</code> – Signature
            has had DNS validation attempted.
          </p></li>
<li class="listitem"><p>
            <code class="literal">DKIM_SIGFLAG_PASSED</code> – DNS
            validation succeeded.
          </p></li>
<li class="listitem"><p>
            <code class="literal">DKIM_SIGFLAG_TESTKEY</code> – Keys "in
            test" flag was set.
          </p></li>
<li class="listitem"><p>
            <code class="literal"> DKIM_SIGFLAG_NOSUBDOMAIN </code> – Keys
            "not for use with subdomains" flag was set.
          </p></li>
</ul></div>
<p>
        These values are found in the <code class="literal">opendkim.dkim</code>
        namespace. For more information about the flags bitmap, see
        <a class="link" href="http://www.opendkim.org/libopendkim/dkim_sig_getflags.html" target="_top">dkim_sig_getflags</a>.
      </p>
<p>
...
<div class="refsection">
<a name="idp18885472"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig_hdrsigned.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.validate.opendkim.get_sig_errorstr </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.validate.opendkim.get_sig_hdrsigned</td>
</tr>
</table></div>
