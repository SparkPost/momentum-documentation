...
<title>msys.validate.opendkim.get_sig_keysize</title>
...
<link rel="prev" href="lua.ref.msys.validate.opendkim.get_sig_identity.php" title="msys.validate.opendkim.get_sig_identity">
<link rel="next" href="lua.ref.msys.validate.opendkim.get_sig_selector.php" title="msys.validate.opendkim.get_sig_selector">
...
<tr><th colspan="3" align="center">msys.validate.opendkim.get_sig_keysize</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.validate.opendkim.get_sig_identity.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig_selector.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.validate.opendkim.get_sig_keysize"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.validate.opendkim.get_sig_keysize — Fetch the size of the key used to generate a signature</p>
</div>
<div class="refsection">
<a name="idp18988832"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.validate.opendkim.get_sig_keysize(dkim_sig)</code>
      </p>
<p>
</p>
...
<div class="refsection">
<a name="idp18992288"></a><h2>Description</h2>
<p>
        This function fetches the size of the key used to generate a
        signature. Use
...
<p>
        This function returns the size of the signing key in bits and
        the DKIM status <code class="literal">DKIM_STAT</code>.
      </p>
<p>
        The <code class="literal">DKIM_STAT</code> can be one of the following
        values:
      </p>
...
<div class="example">
<a name="lua.ref.msys.validate.opendkim.get_sig_keysize.example"></a><p class="title"><b>Example 70.66. msys.validate.opendkim.get_num_sigs example</b></p>
...
<div class="refsection">
<a name="idp19024160"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig_selector.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.validate.opendkim.get_sig_identity </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.validate.opendkim.get_sig_selector</td>
</tr>
</table></div>
