...
<title>msys.audit_series.add</title>
...
<link rel="prev" href="lua.ref.msys.audit.rejections.php" title="msys.audit.rejections">
<link rel="next" href="lua.ref.msys.audit_series.count.php" title="msys.audit_series.count">
...
<tr><th colspan="3" align="center">msys.audit_series.add</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.audit.rejections.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.audit_series.count.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.audit_series.add"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.audit_series.add — Adjust the counter for the current time window of a named series</p>
</div>
<div class="refsection">
<a name="idp17346160"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.audit_series.add(name, options);</code>
      </p>
...
<div class="refsection">
<a name="idp17349104"></a><h2>Description</h2>
<p>
        Adjusts the counter for the current time window of a named
        series. <code class="literal">options</code> can be a table that provides
        the following additional parameters that affect the adjustment:
      </p>
<div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; ">
<li class="listitem"><p>
            <code class="literal">count</code> the amount to adjust by. Defaults
            to <code class="literal">1</code>, but can be any number, positive or
            negative.
          </p></li>
<li class="listitem"><p>
            <code class="literal">key</code> the interpretation depends on the
            series type
          </p></li>
</ul></div>
<div class="sidebar">
...
<p>
        For a CIDR series, the key is interpreted as an IP specifying
        the address of interest. If <code class="literal">accept_construct</code>
        is used as the key, the remote IP of the accept construct is
...
<div class="refsection">
<a name="idp17364688"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.audit_series.count.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.audit.rejections </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.audit_series.count</td>
</tr>
</table></div>
