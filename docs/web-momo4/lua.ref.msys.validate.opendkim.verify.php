...
<title>msys.validate.opendkim.verify</title>
...
<link rel="prev" href="lua.ref.msys.validate.opendkim.sign.php" title="msys.validate.opendkim.sign">
<link rel="next" href="lua.ref.thread.mutex.php" title="thread.mutex">
...
<tr><th colspan="3" align="center">msys.validate.opendkim.verify</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.validate.opendkim.sign.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.thread.mutex.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.validate.opendkim.verify"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.validate.opendkim.verify — Verify a DKIM signature</p>
</div>
<div class="refsection">
<a name="idp19173104"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.validate.opendkim.verify(msg)</code>
      </p>
<p>
</p>
<pre class="literallayout">
msg: userdata, ec_message type</pre>
<p>
      </p>
</div>
<div class="refsection">
<a name="idp19176544"></a><h2>Description</h2>
<p>
        This function verifies a DKIM signature and returns a DKIM
        handle to context-specific information about the message.
        Typically, you would pass the return value of this function to
        other functions such as
        <code class="function">msys.validate.opendkim.get_num_sigs</code> and
        <code class="function">msys.validate.opendkim.get_sig</code>.
      </p>
<p>
...
<p>
          This function should only be invoked in the
          <code class="literal">validate_data</code> validation phase.
        </p>
</div>
<p>
        This function returns a DKIM handle to context-specific
        information about the message and the DKIM status
...
<div class="example">
<a name="lua.ref.msys.validate.opendkim.verify.example"></a><p class="title"><b>Example 70.68. msys.validate.opendkim.verify example</b></p>
...
<div class="refsection">
<a name="idp19209136"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.thread.mutex.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.validate.opendkim.sign </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> thread.mutex</td>
</tr>
</table></div>
