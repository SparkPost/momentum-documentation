...
<title>11.6. Upgrade Ecelerity and the Cassandra Schema on the First Platform Node</title>
...
<link rel="prev" href="upgrade.two_tier.preparation.stop_generations_rolling.php" title="11.5. Stop Transmissions to the First Platform Node">
<link rel="next" href="upgrade.two_tier.preparation.stop_transmissions_rolling.php" title="11.7. Restore Transmissions to the First Platform Node and Stop Transmissions to all other Platform Nodes">
...
<tr><th colspan="3" align="center">11.6. Upgrade Ecelerity and the Cassandra Schema on the First Platform Node</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="upgrade.two_tier.preparation.stop_generations_rolling.php">Prev</a> </td>
<th width="60%" align="center">Chapter 11. Rolling Upgrade - Two-Tier Configuration and Combined Node</th>
<td width="20%" align="right"> <a accesskey="n" href="upgrade.two_tier.preparation.stop_transmissions_rolling.php">Next</a>
</td>
</tr>
</table></div>
<div class="section">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="upgrade.two_tier.preparation.ecelerity_rolling"></a>11.6. Upgrade Ecelerity and the Cassandra Schema on the First Platform Node</h2></div></div></div>
<div class="orderedlist"><ol class="orderedlist" type="1">
<li class="listitem">
<p>
          The following steps connect Ecelerity and Cassandra. These
          steps should be done only on the <span class="bold"><strong>first
          Platform node</strong></span>. Be sure you perform these steps in
...
<p>
              ...
              Cassandra schema to be used) (<span class="bold"><strong>first
              Platform node only</strong></span>).
            </p>
<p>
</p>
<pre class="screen">
...
<li class="listitem">
<p>
              Start ecconfigd (<span class="bold"><strong>first Platform node
              only</strong></span>).
            </p>
<p>
</p>
...
<p>
                ...
                file on <span class="bold"><strong>all nodes</strong></span>.
              </p>
</div>
</li>
</ol></div>
...
<li class="listitem">
<p>
          Modify the <code class="filename">populate_customer_metadata.cql</code>
          file to apply the Cassandra schema
          (<span class="bold"><strong>first Platform node only</strong></span>).
        </p>
<p>
</p>
<pre class="screen">
...
<td width="40%" align="right"> <a accesskey="n" href="upgrade.two_tier.preparation.stop_transmissions_rolling.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">11.5. Stop Transmissions to the First Platform Node </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> 11.7. Restore Transmissions to the First Platform Node and Stop Transmissions
        to all other Platform Nodes</td>
</tr>
</table></div>
