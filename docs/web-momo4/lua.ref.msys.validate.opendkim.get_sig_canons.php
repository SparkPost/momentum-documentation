...
<title>msys.validate.opendkim.get_sig_canons</title>
...
<link rel="prev" href="lua.ref.msys.validate.opendkim.get_sig.php" title="msys.validate.opendkim.get_sig">
<link rel="next" href="lua.ref.msys.validate.opendkim.get_sig_domain.php" title="msys.validate.opendkim.get_sig_domain">
...
<tr><th colspan="3" align="center">msys.validate.opendkim.get_sig_canons</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="lua.ref.msys.validate.opendkim.get_sig.php">Prev</a> </td>
<th width="60%" align="center">Chapter 70. Lua Functions Reference</th>
<td width="20%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig_domain.php">Next</a>
</td>
</tr>
</table></div>
<div class="refentry">
<a name="lua.ref.msys.validate.opendkim.get_sig_canons"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>msys.validate.opendkim.get_sig_canons — Fetch the canonicalizers used for a signature</p>
</div>
<div class="refsection">
<a name="idp18712048"></a><h2>Synopsis</h2>
<p>
        <code class="function">msys.validate.opendkim.get_sig_canons(dkim_sig)</code>
      </p>
<p>
</p>
...
<div class="refsection">
<a name="idp18715504"></a><h2>Description</h2>
<p>
        This function fetches the canonicalizers used for a signature.
        Use <code class="function">msys.validate.opendkim.get_num_sigs</code> and
...
<p>
        This function returns the header canon string and the DKIM
...
<div class="refsection">
<a name="idp18744080"></a><h2>See Also</h2>
<p>
...
<td width="40%" align="right"> <a accesskey="n" href="lua.ref.msys.validate.opendkim.get_sig_domain.php">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">msys.validate.opendkim.get_sig </td>
<td width="20%" align="center"><a accesskey="h" href="index.php">Table of Contents</a></td>
<td width="40%" align="right" valign="top"> msys.validate.opendkim.get_sig_domain</td>
</tr>
</table></div>
