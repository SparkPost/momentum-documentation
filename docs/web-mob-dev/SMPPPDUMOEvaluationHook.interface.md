...
| 14.2. Interface |
| [Prev](SMPPPDUMOEvaluationHook.php)  | Chapter 14. SMPP PDU MO (Receiver) Evaluation Hook |  [Next](SMPPPDUMOEvaluationHook.examples.php) |

## 14.2. Interface

### 14.2.1. Function Interface and Parameters

**14.2.1.1. Function Interface for Lua**`function mod:smpp_MO_pdu_eval (pdu)`**14.2.1.2. Function Interface for C**
```
...
| [Prev](SMPPPDUMOEvaluationHook.php)  | [Up](SMPPPDUMOEvaluationHook.php) |  [Next](SMPPPDUMOEvaluationHook.examples.php) |
| Chapter 14. SMPP PDU MO (Receiver) Evaluation Hook  | [Table of Contents](index.php) |  14.3. Examples |
